			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						...
						{ type: "p", text: "L'app raccoglie i seguenti dati:" },
						{
							type: "ul",
							items: [
								"Dati di account: nome, email, password, data di nascita, sesso, nazionalità, lingua",
								"Dati opzionali: numero di telefono",
								"Dati sanitari: farmaci, terapie, promemoria, medicazioni autonome indicate da medico o personale sanitario, zona da medicare, materiali necessari, istruzioni ricevute, appuntamenti sanitari, diario clinico personale, parametri vitali, sintomi, effetti collaterali, dati glicemici e note sanitarie",
						...
						{ type: "h2", text: "Finalità del trattamento" },
						{
							...
							items: [
								...
								"gestione promemoria, terapie farmacologiche e medicazioni programmate",
								"notifiche push",
								"monitoraggio sanitario personale tramite diario clinico, diario farmaci e diario medicazioni",
						...
						{ type: "p", text: "I dati non vengono venduti. Alcuni dati possono essere trattati da fornitori tecnici necessari al funzionamento, alla sicurezza, alla diagnostica, alle notifiche e alla pubblicità dell'app." },
						{ type: "p", text: "I dati possono essere condivisi solo tra utenti tramite il sistema caregiver, previo consenso esplicito dell'utente." },
						{ type: "p", text: "Il caregiver può esclusivamente visualizzare i dati che l'utente decide di condividere e non può modificarli o accedere ad altri dati non autorizzati." },
						{ type: "p", text: "I fornitori tecnici includono, a seconda delle funzionalità usate, Expo, Google Mobile Ads (AdMob), Sentry e servizi infrastrutturali. Tali fornitori trattano i dati secondo le rispettive informative, termini e garanzie applicabili." },
						{ type: "h2", text: "Sicurezza" },
						{ type: "p", text: "I dati sono salvati su server AWS in Germania (eu-central-1) e protetti tramite misure tecniche e organizzative adeguate, inclusa la crittografia dei dati ove applicabile." },
						{ type: "p", text: "Le comunicazioni tra l'app RememberTo e il server avvengono tramite connessione sicura HTTPS." },
						{ type: "h2", text: "Trasferimento dati" },
						{ type: "p", text: "I dati principali dell'app sono trattati su server situati nell'Unione Europea." },
						{ type: "p", text: "Alcuni servizi tecnici di terze parti, come notifiche push, pubblicità, diagnostica degli errori o servizi infrastrutturali, possono comportare trattamenti da parte dei rispettivi fornitori, anche fuori dallo Spazio Economico Europeo quando necessario, secondo le loro informative privacy, termini di servizio e garanzie applicabili." },
						...
						{ type: "p", text: "RememberTo utilizza Sentry per rilevare errori, crash e problemi di performance, migliorare stabilità e sicurezza dell'app e intervenire più rapidamente sui malfunzionamenti." },
						{ type: "p", text: "Gli eventi diagnostici possono includere informazioni tecniche come modello del dispositivo, sistema operativo, versione dell'app, timestamp, stack trace, tipo di errore, area o schermata coinvolta e breadcrumb tecnici utili alla ricostruzione del problema." },
						{ type: "p", text: "Sentry è configurato con sendDefaultPii: false e con filtri lato app per non inviare automaticamente nome, email, ID utente, cookie, header, corpo delle richieste o query string. Non sono abilitati Session Replay, screenshot o invio intenzionale di contenuti sanitari." },
						{ type: "p", text: "Gli eventi diagnostici sono conservati solo per finalità tecniche, sicurezza, manutenzione e assistenza, secondo le impostazioni di conservazione applicabili al progetto Sentry e alle esigenze operative." },
						{ type: "h2", text: "Pubblicità e consenso annunci" },
						{ type: "p", text: "L'app può mostrare annunci pubblicitari tramite Google Mobile Ads (AdMob). Per il funzionamento degli annunci possono essere trattati dati tecnici, identificatori del dispositivo o identificatori pubblicitari, secondo le impostazioni del dispositivo, le preferenze espresse dall'utente e le regole applicabili." },
						{ type: "p", text: "Gli annunci possono essere personalizzati o non personalizzati in base alle preferenze espresse dall'utente. Per gli utenti nello Spazio Economico Europeo, Regno Unito e Svizzera, RememberTo utilizza i meccanismi di consenso previsti da Google, inclusa la piattaforma User Messaging Platform (UMP), per raccogliere o aggiornare le preferenze relative agli annunci." },
						{ type: "p", text: "L'utente può modificare le preferenze relative agli annunci tramite le impostazioni disponibili nell'app, quando previste." },
						{ type: "h2", text: "Conservazione dei dati" },
						{ type: "p", text: "I dati sanitari sono conservati secondo le impostazioni scelte dall'utente nell'app. Farmaci conclusi e relativo diario, medicazioni concluse e relativo diario, e voci del diario salute possono essere eliminati automaticamente dopo 30, 60, 90 o 120 giorni; il valore predefinito è 90 giorni. Gli appuntamenti vengono eliminati automaticamente dopo 15 giorni dalla data dell'appuntamento, salvo eliminazione manuale precedente." },
						{ type: "p", text: "L'utente può cancellare manualmente i dati in qualsiasi momento dalle funzioni disponibili nell'app oppure eliminare definitivamente account e dati dall'app o contattando rememberto.info@gmail.com." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "L'utente è responsabile della corretta gestione delle proprie terapie, dell'assunzione dei farmaci e dell'esecuzione di medicazioni solo secondo indicazioni ricevute da un medico o da personale sanitario qualificato." },
						...
						{ type: "p", text: "Lo sviluppatore non è responsabile per errori, interruzioni del servizio, ritardi nelle notifiche o perdita di dati." },
						...
						{ type: "p", text: "L'utente può scegliere se conservare farmaci conclusi, medicazioni concluse e voci del diario salute per 30, 60, 90 o 120 giorni, con valore predefinito di 90 giorni. La cancellazione automatica opera secondo tali impostazioni. Gli appuntamenti vengono eliminati automaticamente dopo 15 giorni dalla data dell'appuntamento, salvo eliminazione manuale precedente." },
						{ type: "p", text: "L'utente può comunque eliminare manualmente i dati quando desidera: i farmaci conclusi dal diario farmaci nella sezione dedicata, medicazioni e voci del diario salute direttamente dalle rispettive card." },
						{ type: "h2", text: "Dati sanitari e consenso" },
						{ type: "p", text: "L'utilizzo delle funzionalità sanitarie dell'app richiede il consenso esplicito dell'utente al trattamento dei dati sanitari necessari al funzionamento di RememberTo, inclusi farmaci, terapie, promemoria, medicazioni autonome e relative istruzioni ricevute, appuntamenti sanitari e dati inseriti nel diario clinico personale." },
						{ type: "p", text: "Tali dati sono necessari per l'utilizzo delle funzionalità sanitarie dell'app. L'utente può revocare il consenso, modificare le impostazioni di conservazione dati o eliminare il proprio account secondo le modalità indicate nella Privacy Policy e nella pagina dedicata all'eliminazione account." },
			...
			pages: {
					...
					blocks: [
						...
						{ type: "h2", text: "Purposes of processing" },
						{
							...
							items: [
								...
								"management of reminders, medication therapies and scheduled dressings",
								"push notifications",
						...
						{ type: "p", text: "Health data is retained according to the settings chosen by the user in the app. Completed medicines and related journal, completed dressings and related journal, and health journal entries can be automatically deleted after 30, 60, 90 or 120 days; the default value is 90 days. Appointments are automatically deleted 15 days after the appointment date, unless they were manually deleted earlier." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "The user is responsible for correctly managing their therapies, taking their medicines and performing dressings only according to instructions received from a doctor or qualified healthcare personnel." },
						{ type: "h2", text: "Caregiver" },
						...
						{ type: "p", text: "The user can choose whether to retain completed medicines, completed dressings and health journal entries for 30, 60, 90 or 120 days, with a default value of 90 days. Automatic deletion operates according to these settings. Appointments are automatically deleted 15 days after the appointment date, unless they were manually deleted earlier." },
			...
			pages: {
					...
					blocks: [
						...
						{ type: "h2", text: "Finalités du traitement" },
						{
							...
							items: [
								...
								"gestion des rappels, des traitements médicamenteux et des pansements programmés",
								"notifications push",
						...
						{ type: "p", text: "Les données de santé sont conservées selon les paramètres choisis par l'utilisateur dans l'application. Les médicaments terminés et le journal associé, les pansements terminés et le journal associé, ainsi que les entrées du journal de santé peuvent être supprimés automatiquement après 30, 60, 90 ou 120 jours ; la valeur par défaut est de 90 jours. Les rendez-vous sont supprimés automatiquement 15 jours après la date du rendez-vous, sauf suppression manuelle préalable." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "L'utilisateur est responsable de la bonne gestion de ses traitements, de la prise de ses médicaments et de l'exécution de pansements uniquement selon les indications reçues d'un médecin ou de personnel de santé qualifié." },
						{ type: "h2", text: "Aidant" },
						...
						{ type: "p", text: "L'utilisateur peut choisir de conserver les médicaments terminés, les pansements terminés et les entrées du journal de santé pendant 30, 60, 90 ou 120 jours, avec une valeur par défaut de 90 jours. La suppression automatique fonctionne selon ces paramètres. Les rendez-vous sont supprimés automatiquement 15 jours après la date du rendez-vous, sauf suppression manuelle préalable." },
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						...
						{ type: "h2", text: "Zwecke der Verarbeitung" },
						{
							...
							items: [
								"Betrieb der App",
								"Verwaltung von Erinnerungen, medikamentösen Therapien und geplanten Verbandswechseln",
						...
						{ type: "p", text: "Gesundheitsdaten werden gemäß den vom Nutzer in der App gewählten Einstellungen aufbewahrt. Abgeschlossene Medikamente und das zugehörige Tagebuch, abgeschlossene Verbandswechsel und das zugehörige Tagebuch sowie Einträge im Gesundheitstagebuch können nach 30, 60, 90 oder 120 Tagen automatisch gelöscht werden; der Standardwert beträgt 90 Tage. Termine werden 15 Tage nach dem Termin automatisch gelöscht, sofern sie nicht zuvor manuell gelöscht wurden." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "Der Nutzer ist für die korrekte Verwaltung seiner Therapien, die Einnahme seiner Medikamente und die Durchführung von Verbandswechseln ausschließlich gemäß den Anweisungen eines Arztes oder qualifizierten medizinischen Fachpersonals verantwortlich." },
						{ type: "h2", text: "Caregiver" },
						...
						{ type: "p", text: "Der Nutzer kann wählen, ob abgeschlossene Medikamente, abgeschlossene Verbandswechsel und Einträge im Gesundheitstagebuch 30, 60, 90 oder 120 Tage lang aufbewahrt werden, mit einem Standardwert von 90 Tagen. Die automatische Löschung erfolgt gemäß diesen Einstellungen. Termine werden 15 Tage nach dem Termin automatisch gelöscht, sofern sie nicht zuvor manuell gelöscht wurden." },
			...
			pages: {
					...
					blocks: [
						...
						{ type: "h2", text: "Finalidades del tratamiento" },
						{
							...
							items: [
								...
								"gestión de recordatorios, tratamientos farmacológicos y curas programadas",
								"notificaciones push",
						...
						{ type: "p", text: "Los datos de salud se conservan según los ajustes elegidos por el usuario en la aplicación. Los medicamentos finalizados y su diario, las curas finalizadas y su diario, y las entradas del diario de salud pueden eliminarse automáticamente después de 30, 60, 90 o 120 días; el valor predeterminado es 90 días. Las citas se eliminan automáticamente 15 días después de la fecha de la cita, salvo eliminación manual previa." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "El usuario es responsable de la correcta gestión de sus tratamientos, de la toma de sus medicamentos y de realizar curas solo según las indicaciones recibidas de un médico o de personal sanitario cualificado." },
						...
						{ type: "p", text: "El usuario puede elegir si conservar medicamentos finalizados, curas finalizadas y entradas del diario de salud durante 30, 60, 90 o 120 días, con un valor predeterminado de 90 días. La eliminación automática opera según dichos ajustes. Las citas se eliminan automáticamente 15 días después de la fecha de la cita, salvo eliminación manual previa." },
			...
			pages: {
					...
					blocks: [
						...
						{ type: "h2", text: "Finalidades do tratamento" },
						{
							...
							items: [
								...
								"gestão de lembretes, terapias medicamentosas e pensos programados",
								"notificações push",
						...
						{ type: "p", text: "Os dados de saúde são conservados segundo as definições escolhidas pela pessoa utilizadora na app. Medicamentos concluídos e respetivo diário, pensos concluídos e respetivo diário, e entradas do diário de saúde podem ser eliminados automaticamente após 30, 60, 90 ou 120 dias; o valor predefinido é 90 dias. As consultas são eliminadas automaticamente 15 dias após a data da consulta, salvo eliminação manual anterior." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "A pessoa utilizadora é responsável pela gestão correta das suas terapias, pela toma dos medicamentos e pela realização de pensos apenas segundo indicações recebidas de um médico ou de pessoal de saúde qualificado." },
						{ type: "h2", text: "Cuidador" },
						...
						{ type: "p", text: "A pessoa utilizadora pode escolher se conserva medicamentos concluídos, pensos concluídos e entradas do diário de saúde durante 30, 60, 90 ou 120 dias, com valor predefinido de 90 dias. A eliminação automática funciona segundo essas definições. As consultas são eliminadas automaticamente 15 dias após a data da consulta, salvo eliminação manual anterior." },
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						...
						{ type: "h2", text: "Сврхе обраде" },
						{
							...
							items: [
								"рад апликације",
								"управљање подсетницима, терапијама лековима и заказаним превијањима",
								"push обавештења",
						...
						{ type: "p", text: "Здравствени подаци се чувају у складу са подешавањима која корисник изабере у апликацији. Завршени лекови и повезани дневник, завршена превијања и повезани дневник, као и уноси у здравствени дневник могу се аутоматски избрисати након 30, 60, 90 или 120 дана; подразумевана вредност је 90 дана. Термини се аутоматски бришу 15 дана након датума термина, осим ако су претходно ручно избрисани." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "Корисник је одговоран за правилно управљање својим терапијама, узимање лекова и обављање превијања само према упутствима добијеним од лекара или квалификованог здравственог радника." },
						...
						{ type: "p", text: "Корисник може изабрати да ли ће чувати завршене лекове, завршена превијања и уносе у здравствени дневник 30, 60, 90 или 120 дана, са подразумеваном вредношћу од 90 дана. Аутоматско брисање се врши према тим подешавањима. Термини се аутоматски бришу 15 дана након датума термина, осим ако су претходно ручно избрисани." },
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						...
						{ type: "h2", text: "数据保留" },
						{ type: "p", text: "健康数据会根据用户在应用中选择的设置保留。已结束的药物及相关日记、已结束的换药及相关日记，以及健康日记条目可在 30、60、90 或 120 天后自动删除；默认值为 90 天。预约会在预约日期后 15 天自动删除，除非此前已手动删除。" },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "h2", text: "用户责任" },
						{ type: "p", text: "用户负责正确管理自己的治疗、按要求服用药物，并仅根据医生或合格医疗人员给出的指示进行换药。" },
						{ type: "h2", text: "护理者" },
						...
						{ type: "p", text: "用户可以选择将已结束的药物、已结束的换药和健康日记条目保留 30、60、90 或 120 天，默认值为 90 天。自动删除会按照这些设置执行。预约会在预约日期后 15 天自动删除，除非此前已手动删除。" },
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						...
						{ type: "h2", text: "データ保持" },
						{ type: "p", text: "健康データは、利用者がアプリ内で選択した設定に従って保持されます。終了した薬と関連する日記、終了した創傷処置と関連する日記、および健康日記の項目は、30、60、90、120 日後に自動削除できます。既定値は 90 日です。予約は予約日の 15 日後に自動削除されます。ただし、それ以前に手動で削除された場合を除きます。" },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "h2", text: "利用者の責任" },
						{ type: "p", text: "利用者は、自身の治療管理、薬の服用、および医師または資格のある医療従事者から受けた指示に従った場合に限る創傷処置の実施について責任を負います。" },
						{ type: "h2", text: "介護者" },
						...
						{ type: "p", text: "利用者は、終了した薬、終了した創傷処置、健康日記の項目を 30、60、90、120 日のいずれかで保持するかを選択できます。既定値は 90 日です。自動削除はこれらの設定に従って行われます。予約は予約日の 15 日後に自動削除されます。ただし、それ以前に手動で削除された場合を除きます。" },
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						...
						{ type: "h2", text: "أغراض المعالجة" },
						{
							...
							items: [
								"تشغيل التطبيق",
								"إدارة التذكيرات والعلاجات الدوائية والتضميدات المجدولة",
								"الإشعارات الفورية",
						...
						{ type: "p", text: "يتم الاحتفاظ بالبيانات الصحية وفقا للإعدادات التي يختارها المستخدم في التطبيق. يمكن حذف الأدوية المنتهية واليوميات المرتبطة بها، والتضميدات المنتهية واليوميات المرتبطة بها، وإدخالات يوميات الصحة تلقائيا بعد 30 أو 60 أو 90 أو 120 يوما؛ والقيمة الافتراضية هي 90 يوما. يتم حذف المواعيد تلقائيا بعد 15 يوما من تاريخ الموعد، ما لم يتم حذفها يدويا قبل ذلك." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "يتحمل المستخدم مسؤولية الإدارة الصحيحة لعلاجاته وتناول أدويته وتنفيذ التضميدات فقط وفقا للتعليمات المستلمة من طبيب أو موظفي رعاية صحية مؤهلين." },
						...
						{ type: "p", text: "يمكن للمستخدم اختيار الاحتفاظ بالأدوية المنتهية والتضميدات المنتهية وإدخالات يوميات الصحة لمدة 30 أو 60 أو 90 أو 120 يوما، مع قيمة افتراضية قدرها 90 يوما. يعمل الحذف التلقائي وفقا لهذه الإعدادات. يتم حذف المواعيد تلقائيا بعد 15 يوما من تاريخ الموعد، ما لم يتم حذفها يدويا قبل ذلك." },
