		...
		it: {
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						{ type: "p", text: "RememberTo è un'app dedicata alla gestione di promemoria, terapie farmacologiche, medicazioni autonome indicate da professionisti sanitari, appuntamenti sanitari e monitoraggio personale tramite diario clinico." },
						{ type: "h2", text: "Dati raccolti" },
						{ type: "p", text: "L'app raccoglie dati di account, quali nome, email, password, data di nascita, sesso, nazionalità e lingua; dati opzionali, come il numero di telefono; dati sanitari, tra cui farmaci, terapie, promemoria, medicazioni autonome indicate da medico o personale sanitario, zona da medicare, materiali necessari, istruzioni ricevute, appuntamenti sanitari, diario clinico personale, parametri vitali, sintomi, effetti collaterali, dati glicemici e note sanitarie. Sono inoltre trattati dati tecnici, come identificatori del dispositivo necessari al funzionamento delle notifiche, informazioni sul dispositivo, sistema operativo, versione dell'app, eventi di errore, crash e performance. I dati diagnostici possono includere errori, crash, stack trace, schermata o area dell'app coinvolta, timestamp, versione dell'app, sistema operativo, modello del dispositivo e altre informazioni tecniche necessarie a individuare e correggere malfunzionamenti. Non inviamo intenzionalmente contenuti sanitari a Sentry." },
						{ type: "h2", text: "Finalità del trattamento" },
						{ type: "p", text: "I dati vengono utilizzati per il funzionamento dell'app; la gestione di promemoria, terapie farmacologiche, livelli di avviso e allarmi locali ad alta priorità scelti dall'utente; l'invio di notifiche push e la visualizzazione di avvisi locali sul dispositivo; la gestione caregiver e la condivisione dei dati tra utenti autorizzati; il monitoraggio sanitario personale tramite diario clinico, diario farmaci e diario medicazioni; l'esportazione PDF dei dati sanitari; la visualizzazione di annunci tramite Google Mobile Ads; la gestione delle preferenze privacy e del consenso per gli annunci; il monitoraggio di errori, crash e prestazioni tramite Sentry per sicurezza, manutenzione e miglioramento dell'app." },
						{ type: "h2", text: "Base giuridica" },
						{ type: "p", text: "Il trattamento dei dati si basa sul consenso esplicito dell'utente per le funzionalità che richiedono dati sanitari e, per i dati tecnici necessari a sicurezza, diagnostica e manutenzione dell'app, sull'esecuzione del servizio e/o sul legittimo interesse del titolare, nei limiti previsti dal GDPR." },
						{ type: "h2", text: "Condivisione dei dati" },
						{ type: "p", text: "I dati non vengono venduti. Alcuni dati possono essere trattati da fornitori tecnici necessari al funzionamento, alla sicurezza, alla diagnostica, alle notifiche e alla pubblicità dell'app. I dati possono essere condivisi tra utenti tramite il sistema caregiver soltanto previo consenso esplicito dell'utente. Il caregiver può esclusivamente visualizzare i dati che l'utente decide di condividere e non può modificarli o accedere ad altri dati non autorizzati. I fornitori tecnici includono, a seconda delle funzionalità utilizzate, Expo, Google Mobile Ads (AdMob), Sentry e servizi infrastrutturali, che trattano i dati secondo le rispettive informative, condizioni e garanzie applicabili." },
						{ type: "h2", text: "Sicurezza e trasferimento dei dati" },
						{ type: "p", text: "I dati sono salvati su server AWS in Germania, nella regione eu-central-1, e protetti tramite misure tecniche e organizzative adeguate, inclusa la crittografia ove applicabile. Le comunicazioni tra RememberTo e il server avvengono tramite connessione HTTPS. I dati principali dell'app sono trattati su server situati nell'Unione Europea. Alcuni servizi tecnici di terze parti possono comportare trattamenti anche fuori dallo Spazio Economico Europeo, quando necessario, secondo le rispettive informative, condizioni di servizio e garanzie applicabili." },
						{ type: "h2", text: "Servizi esterni" },
						{ type: "p", text: "RememberTo utilizza Expo Push Notifications per l'invio delle notifiche push, Google Mobile Ads per gli annunci pubblicitari, servizi infrastrutturali necessari all'app e al backend e Sentry, fornito da Functional Software, Inc., per il monitoraggio di errori, crash e prestazioni." },
						{ type: "h2", text: "Diagnostica, crash e performance" },
						{ type: "p", text: "RememberTo utilizza Sentry per rilevare errori, crash e problemi di performance, migliorare stabilità e sicurezza e intervenire più rapidamente sui malfunzionamenti. Gli eventi diagnostici possono includere modello del dispositivo, sistema operativo, versione dell'app, timestamp, stack trace, tipo di errore, area o schermata coinvolta e breadcrumb tecnici. Sentry è configurato con sendDefaultPii: false e con filtri lato app per non inviare automaticamente nome, email, ID utente, cookie, header, corpo delle richieste o query string. Non sono abilitati Session Replay, screenshot o invio intenzionale di contenuti sanitari. Gli eventi sono conservati esclusivamente per finalità tecniche, sicurezza, manutenzione e assistenza." },
						{ type: "h2", text: "Pubblicità e consenso agli annunci" },
						{ type: "p", text: "L'app può mostrare annunci tramite Google Mobile Ads. Per il loro funzionamento possono essere trattati dati tecnici, identificatori del dispositivo o identificatori pubblicitari, secondo le impostazioni del dispositivo, le preferenze dell'utente e le regole applicabili. Gli annunci possono essere personalizzati o non personalizzati. Per gli utenti nello Spazio Economico Europeo, Regno Unito e Svizzera, RememberTo utilizza i meccanismi di consenso di Google, inclusa User Messaging Platform. Le preferenze possono essere modificate dalle impostazioni disponibili nell'app." },
						{ type: "h2", text: "Conservazione e cancellazione" },
						{ type: "p", text: "Farmaci conclusi e relativo diario, medicazioni concluse e relativo diario e voci del diario salute possono essere eliminati automaticamente dopo 30, 60, 90 o 120 giorni; il valore predefinito è 90 giorni. Gli appuntamenti passati vengono eliminati automaticamente 15 giorni dopo la data dell'appuntamento. L'utente può cancellare manualmente i dati in qualsiasi momento oppure eliminare definitivamente account e dati dall'app o contattando rememberto.info@gmail.com." },
						{ type: "h2", text: "Disclaimer medico" },
						{ type: "p", text: "RememberTo non fornisce consulenza medica, non spiega come eseguire medicazioni e non sostituisce il parere di un medico o professionista sanitario. Le medicazioni devono essere eseguite solo se indicate da un medico o da personale sanitario qualificato." },
						{ type: "h2", text: "Diritti dell'utente" },
						{ type: "p", text: "L'utente può accedere ai propri dati, modificarli, cancellarli, revocare il consenso, opporsi al trattamento, richiedere la limitazione del trattamento e richiedere la portabilità dei dati." },
						{ type: "h2", text: "Età minima" },
						{ type: "p", text: "L'app è destinata a utenti di almeno 16 anni." },
						...
						{ type: "p", text: "La presente informativa può essere aggiornata nel tempo. Gli utenti saranno informati in caso di modifiche rilevanti." },
					],
				},
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "Per i farmaci l'utente può scegliere un avviso normale, basato sulle notifiche, oppure un avviso di livello alto, che programma sul dispositivo un allarme locale esatto con suono, vibrazione e possibile apertura a schermo intero, anche a dispositivo bloccato, nei limiti consentiti da Android e dalle impostazioni del dispositivo. Il livello alto deve essere scelto espressamente per il singolo farmaco e richiede autorizzazioni speciali per allarmi esatti e avvisi a schermo intero. Tali autorizzazioni possono essere negate o revocate dall'utente o dal sistema. Notifiche e allarmi possono subire ritardi, essere limitati o non essere mostrati a causa di impostazioni del dispositivo, risparmio energetico, permessi, indisponibilità dei servizi, riavvii, aggiornamenti o altri fattori tecnici e non sono pertanto garantiti." },
						{ type: "h2", text: "Contenuti sanitari" },
						{ type: "p", text: "L'app non sostituisce medici o professionisti sanitari, non prescrive terapie e non fornisce istruzioni autonome su come eseguire medicazioni." },
						{ type: "h2", text: "Responsabilità dell'utente" },
						{ type: "p", text: "L'utente è responsabile della corretta gestione delle proprie terapie, dell'assunzione dei farmaci e dell'esecuzione di medicazioni solo secondo indicazioni ricevute da un medico o da personale sanitario qualificato. È inoltre responsabile della scelta del livello di avviso, della correttezza degli orari inseriti e della verifica periodica di volume, permessi e impostazioni del dispositivo. RememberTo non deve essere utilizzata come unico sistema per promemoria sanitari urgenti, critici o salvavita." },
						{ type: "h2", text: "Caregiver" },
						{ type: "p", text: "L'accesso ai dati da parte del caregiver avviene solo con consenso esplicito dell'utente." },
						{ type: "p", text: "Il caregiver può esclusivamente visualizzare i dati condivisi dall'utente e non può modificarli." },
						...
						{ type: "p", text: "Nei limiti consentiti dalla legge, lo sviluppatore non è responsabile per errori, interruzioni del servizio, ritardi, mancata attivazione o soppressione di notifiche e allarmi dovuti al dispositivo, al sistema operativo, ai permessi, alla connettività o a servizi di terze parti, né per perdita di dati o conseguenze derivanti dall'affidamento esclusivo ai promemoria dell'app." },
						{ type: "h2", text: "Esportazione PDF" },
						{ type: "p", text: "L'app può consentire l'esportazione dei dati sanitari in formato PDF." },
						{ type: "p", text: "L'utente è responsabile della conservazione e dell'eventuale condivisione dei documenti esportati." },
						{ type: "h2", text: "Conservazione e cancellazione dei dati" },
						{ type: "p", text: "L'utente può scegliere se conservare farmaci conclusi, medicazioni concluse e voci del diario salute per 30, 60, 90 o 120 giorni, con valore predefinito di 90 giorni. Gli appuntamenti passati vengono eliminati automaticamente 15 giorni dopo la data dell'appuntamento. I farmaci conclusi possono essere eliminati manualmente dalla sezione dedicata del diario farmaci; medicazioni e voci del diario salute direttamente dalle rispettive schede." },
						{ type: "h2", text: "Dati sanitari e consenso" },
						{ type: "p", text: "L'utilizzo delle funzionalità sanitarie richiede il consenso esplicito al trattamento dei dati necessari al funzionamento di RememberTo, inclusi farmaci, terapie, promemoria, medicazioni autonome e relative istruzioni ricevute, appuntamenti sanitari e dati del diario clinico personale. L'utente può revocare il consenso, modificare la conservazione dei dati o eliminare il proprio account secondo quanto indicato nella Privacy Policy." },
						{ type: "h2", text: "Pubblicità" },
						{ type: "p", text: "L'app può mostrare annunci pubblicitari tramite Google Mobile Ads (AdMob). Gli annunci personalizzati vengono mostrati solo secondo le preferenze espresse dall'utente e tramite i meccanismi di consenso disponibili nell'app." },
						{ type: "p", text: "L'utente può modificare le preferenze relative agli annunci dalle impostazioni dell'app, quando disponibili." },
						{ type: "h2", text: "Diagnostica e stabilità" },
						{ type: "p", text: "L'app può utilizzare strumenti tecnici come Sentry per registrare errori, crash e problemi di performance al fine di mantenere, proteggere e migliorare il servizio." },
		...
		en: {
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						{ type: "p", text: "RememberTo is an app dedicated to managing reminders, medication therapies, self-administered dressings indicated by healthcare professionals, healthcare appointments and personal monitoring through a clinical journal." },
						{ type: "h2", text: "Data collected" },
						{ type: "p", text: "The app collects the following data:" },
						{
							type: "ul",
							items: [
								"Account data: name, email, password, date of birth, sex, nationality, language",
								"Optional data: phone number",
								"Health data: medicines, therapies, reminders, self-administered dressings indicated by a doctor or healthcare professional, area to be dressed, necessary materials, instructions received, healthcare appointments, personal clinical journal, vital parameters, symptoms, side effects, glucose data and health notes",
						...
						{ type: "h2", text: "Purposes of processing" },
						{
							...
							items: [
								...
								"management of reminders, medication therapies, alert levels and high-priority local alarms selected by the user",
								"sending push notifications and displaying local alerts on the device",
								"personal health monitoring through the clinical journal, medication journal and dressing journal",
						...
						{ type: "p", text: "Data processing is based on the user's explicit consent for features that require health data and, for technical data needed for app security, diagnostics and maintenance, on the performance of the service and/or the controller's legitimate interest, within the limits provided by the GDPR." },
						{ type: "h2", text: "Data sharing" },
						{ type: "p", text: "Data is not sold. Some data may be processed by technical providers required for the operation, security, diagnostics, notifications and advertising of the app." },
						{ type: "p", text: "Data may be shared only between users through the caregiver system, with the user's explicit consent." },
						{ type: "p", text: "The caregiver can only view the data that the user decides to share and cannot modify it or access other unauthorized data." },
						{ type: "p", text: "Technical providers include, depending on the features used, Expo, Google Mobile Ads (AdMob), Sentry and infrastructure services. These providers process data according to their respective policies, terms and applicable safeguards." },
						{ type: "h2", text: "Security" },
						{ type: "p", text: "Data is stored on AWS servers in Germany (eu-central-1) and protected through appropriate technical and organizational measures, including data encryption where applicable." },
						...
						{ type: "p", text: "The app's main data is processed on servers located in the European Union." },
						{ type: "p", text: "Some third-party technical services, such as push notifications, advertising, error diagnostics or infrastructure services, may involve processing by their respective providers, including outside the European Economic Area when necessary, according to their privacy policies, terms of service and applicable safeguards." },
						...
						{ type: "p", text: "RememberTo uses Sentry to detect errors, crashes and performance issues, improve the app's stability and security, and respond more quickly to malfunctions." },
						{ type: "p", text: "Diagnostic events may include technical information such as device model, operating system, app version, timestamp, stack trace, error type, area or screen involved and technical breadcrumbs useful for reconstructing the issue." },
						{ type: "p", text: "Sentry is configured with sendDefaultPii: false and app-side filters so that name, email, user ID, cookies, headers, request body or query strings are not sent automatically. Session Replay, screenshots and intentional sending of health content are not enabled." },
						{ type: "p", text: "Diagnostic events are retained only for technical, security, maintenance and support purposes, according to the retention settings applicable to the Sentry project and operational needs." },
						{ type: "h2", text: "Advertising and ad consent" },
						{ type: "p", text: "The app may display advertisements through Google Mobile Ads (AdMob). Technical data, device identifiers or advertising identifiers may be processed for ads to work, according to device settings, the preferences expressed by the user and applicable rules." },
						{ type: "p", text: "Ads may be personalized or non-personalized based on the preferences expressed by the user. For users in the European Economic Area, the United Kingdom and Switzerland, RememberTo uses Google's consent mechanisms, including the User Messaging Platform (UMP), to collect or update ad preferences." },
						...
						{ type: "p", text: "Completed medicines and related journal, completed dressings and related journal, and health journal entries can be automatically deleted after 30, 60, 90 or 120 days; the default value is 90 days. Past appointments are automatically deleted 15 days after the appointment date." },
						{ type: "p", text: "The user can manually delete data at any time through the features available in the app, or permanently delete the account and data from the app or by contacting rememberto.info@gmail.com." },
						{ type: "h2", text: "Medical disclaimer" },
						{ type: "p", text: "RememberTo does not provide medical advice, does not explain how to perform dressings and does not replace the opinion of a doctor or healthcare professional. Dressings must be performed only if indicated by a doctor or qualified healthcare personnel." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "For medicines, the user can choose a normal alert based on notifications or a high-level alert that schedules an exact local alarm on the device with sound, vibration and possible full-screen display, even when the device is locked, within the limits allowed by Android and the device settings. The high level must be expressly selected for each medicine and requires special permissions for exact alarms and full-screen alerts. These permissions may be denied or revoked by the user or the system. Notifications and alarms may be delayed, limited or not displayed due to device settings, battery saving, permissions, service unavailability, restarts, updates or other technical factors and are therefore not guaranteed." },
						{ type: "h2", text: "Health content" },
						{ type: "p", text: "The app does not replace doctors or healthcare professionals, does not prescribe therapies and does not provide independent instructions on how to perform dressings." },
						{ type: "h2", text: "User responsibility" },
						{ type: "p", text: "The user is responsible for correctly managing their therapies, taking their medicines and performing dressings only according to instructions received from a doctor or qualified healthcare personnel. The user is also responsible for selecting the alert level, ensuring the entered times are correct and periodically checking the device volume, permissions and settings. RememberTo must not be used as the sole system for urgent, critical or life-saving health reminders." },
						{ type: "h2", text: "Caregiver" },
						...
						{ type: "p", text: "To the extent permitted by law, the developer is not responsible for errors, service interruptions, delays, failure to activate or suppression of notifications and alarms caused by the device, operating system, permissions, connectivity or third-party services, nor for data loss or consequences arising from relying exclusively on the app's reminders." },
						...
						{ type: "p", text: "The user can choose whether to retain completed medicines, completed dressings and health journal entries for 30, 60, 90 or 120 days, with a default value of 90 days. Past appointments are automatically deleted 15 days after the appointment date." },
						{ type: "p", text: "The user can still manually delete data whenever they wish: completed medicines from the medication journal in the dedicated section, and dressings and health journal entries directly from their respective cards." },
						{ type: "h2", text: "Health data and consent" },
						{ type: "p", text: "Use of the app's health features requires the user's explicit consent to process the health data needed for RememberTo to operate, including medicines, therapies, reminders, self-administered dressings and related instructions received, healthcare appointments and data entered in the personal clinical journal." },
						{ type: "p", text: "Such data is necessary to use the app's health features. The user can withdraw consent, change data retention settings or delete their account according to the methods described in the Privacy Policy and on the account deletion page." },
						{ type: "h2", text: "Advertising" },
						{ type: "p", text: "The app may display advertisements through Google Mobile Ads (AdMob). Personalized ads are shown only according to the preferences expressed by the user and through the consent mechanisms available in the app." },
						...
						{ type: "p", text: "The app may use technical tools such as Sentry to record errors, crashes and performance issues in order to maintain, protect and improve the service." },
		...
		fr: {
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						{ type: "p", text: "RememberTo est une application dédiée à la gestion des rappels, des traitements médicamenteux, des pansements autonomes indiqués par des professionnels de santé, des rendez-vous de santé et du suivi personnel au moyen d'un journal clinique." },
						{ type: "h2", text: "Données collectées" },
						{ type: "p", text: "L'application collecte les données suivantes :" },
						{
							type: "ul",
							items: [
								...
								"Données de santé : médicaments, traitements, rappels, pansements autonomes indiqués par un médecin ou un professionnel de santé, zone à panser, matériel nécessaire, instructions reçues, rendez-vous de santé, journal clinique personnel, paramètres vitaux, symptômes, effets indésirables, données glycémiques et notes de santé",
						...
						{ type: "h2", text: "Finalités du traitement" },
						{
							...
							items: [
								...
								"gestion des rappels, des traitements médicamenteux, des niveaux d'alerte et des alarmes locales hautement prioritaires choisis par l'utilisateur",
								"envoi de notifications push et affichage d'alertes locales sur l'appareil",
								"suivi personnel de santé au moyen du journal clinique, du journal des médicaments et du journal des pansements",
						...
						{ type: "p", text: "L'aidant peut uniquement consulter les données que l'utilisateur décide de partager et ne peut pas les modifier ni accéder à d'autres données non autorisées." },
						{ type: "p", text: "Les fournisseurs techniques incluent, selon les fonctionnalités utilisées, Expo, Google Mobile Ads (AdMob), Sentry et des services d'infrastructure. Ces fournisseurs traitent les données selon leurs propres politiques, conditions et garanties applicables." },
						{ type: "h2", text: "Sécurité" },
						{ type: "p", text: "Les données sont stockées sur des serveurs AWS en Allemagne (eu-central-1) et protégées par des mesures techniques et organisationnelles appropriées, y compris le chiffrement des données lorsque cela s'applique." },
						...
						{ type: "p", text: "Les données principales de l'application sont traitées sur des serveurs situés dans l'Union européenne." },
						{ type: "p", text: "Certains services techniques tiers, comme les notifications push, la publicité, le diagnostic des erreurs ou les services d'infrastructure, peuvent impliquer des traitements par leurs fournisseurs respectifs, y compris hors de l'Espace économique européen lorsque cela est nécessaire, selon leurs politiques de confidentialité, conditions de service et garanties applicables." },
						...
						{ type: "p", text: "RememberTo utilise Sentry pour détecter les erreurs, crashs et problèmes de performance, améliorer la stabilité et la sécurité de l'application et intervenir plus rapidement en cas de dysfonctionnement." },
						{ type: "p", text: "Les événements de diagnostic peuvent inclure des informations techniques telles que le modèle de l'appareil, le système d'exploitation, la version de l'application, l'horodatage, la stack trace, le type d'erreur, la zone ou l'écran concerné et des breadcrumbs techniques utiles à la reconstitution du problème." },
						{ type: "p", text: "Sentry est configuré avec sendDefaultPii: false et avec des filtres côté application afin de ne pas envoyer automatiquement le nom, l'e-mail, l'ID utilisateur, les cookies, les en-têtes, le corps des requêtes ou les query strings. Session Replay, les captures d'écran et l'envoi intentionnel de contenus de santé ne sont pas activés." },
						{ type: "p", text: "Les événements de diagnostic sont conservés uniquement à des fins techniques, de sécurité, de maintenance et d'assistance, selon les paramètres de conservation applicables au projet Sentry et les besoins opérationnels." },
						{ type: "h2", text: "Publicité et consentement aux annonces" },
						{ type: "p", text: "L'application peut afficher des publicités via Google Mobile Ads (AdMob). Pour le fonctionnement des annonces, des données techniques, des identifiants d'appareil ou des identifiants publicitaires peuvent être traités selon les paramètres de l'appareil, les préférences exprimées par l'utilisateur et les règles applicables." },
						{ type: "p", text: "Les annonces peuvent être personnalisées ou non personnalisées selon les préférences exprimées par l'utilisateur. Pour les utilisateurs de l'Espace économique européen, du Royaume-Uni et de la Suisse, RememberTo utilise les mécanismes de consentement prévus par Google, y compris la plateforme User Messaging Platform (UMP), afin de collecter ou de mettre à jour les préférences relatives aux annonces." },
						...
						{ type: "p", text: "Les médicaments terminés et le journal associé, les pansements terminés et le journal associé, ainsi que les entrées du journal de santé peuvent être supprimés automatiquement après 30, 60, 90 ou 120 jours ; la valeur par défaut est de 90 jours. Les rendez-vous passés sont automatiquement supprimés 15 jours après la date du rendez-vous." },
						{ type: "p", text: "L'utilisateur peut supprimer manuellement les données à tout moment au moyen des fonctionnalités disponibles dans l'application, ou supprimer définitivement le compte et les données depuis l'application ou en contactant rememberto.info@gmail.com." },
						{ type: "h2", text: "Avertissement médical" },
						{ type: "p", text: "RememberTo ne fournit pas de conseil médical, n'explique pas comment effectuer des pansements et ne remplace pas l'avis d'un médecin ou d'un professionnel de santé. Les pansements doivent être effectués uniquement s'ils sont indiqués par un médecin ou par du personnel de santé qualifié." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "h2", text: "Service" },
						{ type: "p", text: "Pour les médicaments, l'utilisateur peut choisir une alerte normale, basée sur les notifications, ou une alerte de niveau élevé, qui programme sur l'appareil une alarme locale exacte avec son, vibration et éventuelle ouverture en plein écran, même lorsque l'appareil est verrouillé, dans les limites autorisées par Android et les paramètres de l'appareil. Le niveau élevé doit être expressément choisi pour chaque médicament et nécessite des autorisations spéciales pour les alarmes exactes et les alertes en plein écran. Ces autorisations peuvent être refusées ou révoquées par l'utilisateur ou le système. Les notifications et alarmes peuvent être retardées, limitées ou ne pas s'afficher en raison des paramètres de l'appareil, de l'économie d'énergie, des autorisations, de l'indisponibilité des services, des redémarrages, des mises à jour ou d'autres facteurs techniques et ne sont donc pas garanties." },
						{ type: "h2", text: "Contenus de santé" },
						{ type: "p", text: "L'application ne remplace pas les médecins ni les professionnels de santé, ne prescrit pas de traitements et ne fournit pas d'instructions autonomes sur la manière d'effectuer des pansements." },
						{ type: "h2", text: "Responsabilité de l'utilisateur" },
						{ type: "p", text: "L'utilisateur est responsable de la bonne gestion de ses traitements, de la prise de ses médicaments et de l'exécution de pansements uniquement selon les indications reçues d'un médecin ou de personnel de santé qualifié. Il est également responsable du choix du niveau d'alerte, de l'exactitude des horaires saisis et de la vérification périodique du volume, des autorisations et des paramètres de l'appareil. RememberTo ne doit pas être utilisé comme seul système pour les rappels de santé urgents, critiques ou vitaux." },
						{ type: "h2", text: "Aidant" },
						...
						{ type: "p", text: "Dans les limites autorisées par la loi, le développeur n'est pas responsable des erreurs, interruptions du service, retards, absence d'activation ou suppression de notifications et d'alarmes dues à l'appareil, au système d'exploitation, aux autorisations, à la connectivité ou à des services tiers, ni de la perte de données ou des conséquences résultant de la confiance exclusive accordée aux rappels de l'application." },
						...
						{ type: "h2", text: "Conservation et suppression des données" },
						{ type: "p", text: "L'utilisateur peut choisir de conserver les médicaments terminés, les pansements terminés et les entrées du journal de santé pendant 30, 60, 90 ou 120 jours, avec une valeur par défaut de 90 jours. Les rendez-vous passés sont automatiquement supprimés 15 jours après la date du rendez-vous." },
						{ type: "p", text: "L'utilisateur peut toutefois supprimer manuellement les données quand il le souhaite : les médicaments terminés depuis le journal des médicaments dans la section dédiée, les pansements et les entrées du journal de santé directement depuis leurs cartes respectives." },
						{ type: "h2", text: "Données de santé et consentement" },
						{ type: "p", text: "L'utilisation des fonctionnalités de santé de l'application requiert le consentement explicite de l'utilisateur au traitement des données de santé nécessaires au fonctionnement de RememberTo, notamment les médicaments, traitements, rappels, pansements autonomes et instructions reçues associées, rendez-vous de santé et données saisies dans le journal clinique personnel." },
						{ type: "p", text: "Ces données sont nécessaires à l'utilisation des fonctionnalités de santé de l'application. L'utilisateur peut retirer son consentement, modifier les paramètres de conservation des données ou supprimer son compte selon les modalités indiquées dans la Politique de confidentialité et sur la page dédiée à la suppression du compte." },
						{ type: "h2", text: "Publicité" },
						{ type: "p", text: "L'application peut afficher des publicités via Google Mobile Ads (AdMob). Les annonces personnalisées sont affichées uniquement selon les préférences exprimées par l'utilisateur et au moyen des mécanismes de consentement disponibles dans l'application." },
						...
						{ type: "p", text: "L'application peut utiliser des outils techniques comme Sentry pour enregistrer les erreurs, crashs et problèmes de performance afin de maintenir, protéger et améliorer le service." },
		...
		de: {
			...
			pages: {
				...
				privacy: {
					...
					updated: "September 2026",
					blocks: [
						{ type: "p", text: "RememberTo ist eine App zur Verwaltung von Erinnerungen, medikamentösen Therapien, selbst durchgeführten Verbandswechseln nach Anweisung von medizinischem Fachpersonal, Gesundheitsterminen und persönlicher Überwachung über ein klinisches Tagebuch." },
						{ type: "h2", text: "Erhobene Daten" },
						{ type: "p", text: "Die App erhebt die folgenden Daten:" },
						{
							type: "ul",
							items: [
								"Kontodaten: Name, E-Mail, Passwort, Geburtsdatum, Geschlecht, Nationalität, Sprache",
								"Optionale Daten: Telefonnummer",
								"Gesundheitsdaten: Medikamente, Therapien, Erinnerungen, selbst durchgeführte Verbandswechsel nach Anweisung eines Arztes oder medizinischen Fachpersonals, zu versorgender Bereich, benötigte Materialien, erhaltene Anweisungen, Gesundheitstermine, persönliches klinisches Tagebuch, Vitalparameter, Symptome, Nebenwirkungen, Blutzuckerwerte und Gesundheitsnotizen",
						...
						{ type: "h2", text: "Zwecke der Verarbeitung" },
						{
							...
							items: [
								"Betrieb der App",
								"Verwaltung von Erinnerungen, medikamentösen Therapien, Warnstufen und vom Nutzer gewählten lokalen Alarmen mit hoher Priorität",
								"Versand von Push-Benachrichtigungen und Anzeige lokaler Warnhinweise auf dem Gerät",
								"persönliche Gesundheitsüberwachung über das klinische Tagebuch, Medikamententagebuch und Verbandstagebuch",
						...
						{ type: "p", text: "Der Caregiver kann ausschließlich die Daten einsehen, die der Nutzer freigibt, und kann sie nicht ändern oder auf andere nicht autorisierte Daten zugreifen." },
						{ type: "p", text: "Technische Anbieter umfassen je nach genutzten Funktionen Expo, Google Mobile Ads (AdMob), Sentry und Infrastrukturdienste. Diese Anbieter verarbeiten Daten gemäß ihren jeweiligen Richtlinien, Bedingungen und anwendbaren Schutzmaßnahmen." },
						{ type: "h2", text: "Sicherheit" },
						{ type: "p", text: "Daten werden auf AWS-Servern in Deutschland (eu-central-1) gespeichert und durch geeignete technische und organisatorische Maßnahmen geschützt, einschließlich Datenverschlüsselung, soweit anwendbar." },
						...
						{ type: "p", text: "RememberTo verwendet Sentry, um Fehler, Abstürze und Leistungsprobleme zu erkennen, Stabilität und Sicherheit der App zu verbessern und schneller auf Fehlfunktionen zu reagieren." },
						{ type: "p", text: "Diagnoseereignisse können technische Informationen enthalten, etwa Gerätemodell, Betriebssystem, App-Version, Zeitstempel, Stacktrace, Fehlertyp, betroffener Bereich oder Bildschirm sowie technische Breadcrumbs, die zur Rekonstruktion des Problems nützlich sind." },
						{ type: "p", text: "Sentry ist mit sendDefaultPii: false und App-seitigen Filtern konfiguriert, damit Name, E-Mail, Nutzer-ID, Cookies, Header, Request Body oder Query Strings nicht automatisch gesendet werden. Session Replay, Screenshots und das absichtliche Senden von Gesundheitsinhalten sind nicht aktiviert." },
						{ type: "p", text: "Diagnoseereignisse werden nur für technische Zwecke, Sicherheit, Wartung und Support aufbewahrt, gemäß den für das Sentry-Projekt geltenden Aufbewahrungseinstellungen und betrieblichen Erfordernissen." },
						{ type: "h2", text: "Werbung und Anzeigen-Einwilligung" },
						{ type: "p", text: "Die App kann Werbung über Google Mobile Ads (AdMob) anzeigen. Für den Betrieb der Anzeigen können technische Daten, Gerätekennungen oder Werbekennungen gemäß Geräteeinstellungen, den vom Nutzer geäußerten Präferenzen und den anwendbaren Regeln verarbeitet werden." },
						{ type: "p", text: "Anzeigen können je nach Präferenzen des Nutzers personalisiert oder nicht personalisiert sein. Für Nutzer im Europäischen Wirtschaftsraum, im Vereinigten Königreich und in der Schweiz verwendet RememberTo die von Google vorgesehenen Einwilligungsmechanismen, einschließlich der User Messaging Platform (UMP), um Anzeigenpräferenzen zu erfassen oder zu aktualisieren." },
						...
						{ type: "p", text: "Abgeschlossene Medikamente und das zugehörige Tagebuch, abgeschlossene Verbandswechsel und das zugehörige Tagebuch sowie Einträge im Gesundheitstagebuch können nach 30, 60, 90 oder 120 Tagen automatisch gelöscht werden; der Standardwert beträgt 90 Tage. Vergangene Termine werden 15 Tage nach dem Termin automatisch gelöscht." },
						{ type: "p", text: "Der Nutzer kann Daten jederzeit manuell über die in der App verfügbaren Funktionen löschen oder Konto und Daten endgültig in der App oder durch Kontaktaufnahme mit rememberto.info@gmail.com löschen." },
						{ type: "h2", text: "Medizinischer Hinweis" },
						{ type: "p", text: "RememberTo bietet keine medizinische Beratung, erklärt nicht, wie Verbandswechsel durchzuführen sind, und ersetzt nicht die Einschätzung eines Arztes oder medizinischen Fachpersonals. Verbandswechsel dürfen nur durchgeführt werden, wenn sie von einem Arzt oder qualifiziertem medizinischem Fachpersonal angeordnet wurden." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "h2", text: "Dienst" },
						{ type: "p", text: "Bei Medikamenten kann der Nutzer zwischen einem normalen Hinweis auf Basis von Benachrichtigungen und einem Hinweis mit hoher Priorität wählen, der auf dem Gerät einen exakten lokalen Alarm mit Ton, Vibration und möglicher Vollbildanzeige auch bei gesperrtem Gerät plant, soweit dies von Android und den Geräteeinstellungen zugelassen wird. Die hohe Priorität muss für jedes einzelne Medikament ausdrücklich ausgewählt werden und erfordert besondere Berechtigungen für exakte Alarme und Vollbildbenachrichtigungen. Diese Berechtigungen können vom Nutzer oder vom System verweigert oder widerrufen werden. Benachrichtigungen und Alarme können aufgrund von Geräteeinstellungen, Energiesparfunktionen, Berechtigungen, nicht verfügbaren Diensten, Neustarts, Updates oder anderen technischen Faktoren verzögert, eingeschränkt oder nicht angezeigt werden und sind daher nicht garantiert." },
						{ type: "h2", text: "Gesundheitsinhalte" },
						{ type: "p", text: "Die App ersetzt keine Ärzte oder medizinisches Fachpersonal, verschreibt keine Therapien und stellt keine eigenständigen Anweisungen zur Durchführung von Verbandswechseln bereit." },
						{ type: "h2", text: "Verantwortung des Nutzers" },
						{ type: "p", text: "Der Nutzer ist für die korrekte Verwaltung seiner Therapien, die Einnahme seiner Medikamente und die Durchführung von Verbandswechseln ausschließlich gemäß den Anweisungen eines Arztes oder qualifizierten medizinischen Fachpersonals verantwortlich. Er ist außerdem für die Wahl der Warnstufe, die Richtigkeit der eingegebenen Zeiten sowie die regelmäßige Überprüfung von Lautstärke, Berechtigungen und Geräteeinstellungen verantwortlich. RememberTo darf nicht als einziges System für dringende, kritische oder lebensrettende Gesundheitserinnerungen verwendet werden." },
						{ type: "h2", text: "Caregiver" },
						...
						{ type: "p", text: "Soweit gesetzlich zulässig, haftet der Entwickler nicht für Fehler, Dienstunterbrechungen, Verzögerungen, die Nichtaktivierung oder Unterdrückung von Benachrichtigungen und Alarmen aufgrund des Geräts, des Betriebssystems, der Berechtigungen, der Konnektivität oder von Diensten Dritter sowie nicht für Datenverluste oder Folgen, die aus dem ausschließlichen Vertrauen auf die Erinnerungen der App entstehen." },
						{ type: "h2", text: "PDF-Export" },
						...
						{ type: "h2", text: "Datenspeicherung und Löschung" },
						{ type: "p", text: "Der Nutzer kann wählen, ob abgeschlossene Medikamente, abgeschlossene Verbandswechsel und Einträge im Gesundheitstagebuch 30, 60, 90 oder 120 Tage lang aufbewahrt werden, mit einem Standardwert von 90 Tagen. Vergangene Termine werden 15 Tage nach dem Termin automatisch gelöscht." },
						{ type: "p", text: "Der Nutzer kann Daten dennoch jederzeit manuell löschen: abgeschlossene Medikamente aus dem Medikamententagebuch im entsprechenden Bereich, Verbandswechsel und Einträge im Gesundheitstagebuch direkt über die jeweiligen Karten." },
						{ type: "h2", text: "Gesundheitsdaten und Einwilligung" },
						{ type: "p", text: "Die Nutzung der Gesundheitsfunktionen der App erfordert die ausdrückliche Einwilligung des Nutzers zur Verarbeitung der Gesundheitsdaten, die für den Betrieb von RememberTo erforderlich sind, einschließlich Medikamente, Therapien, Erinnerungen, selbst durchgeführte Verbandswechsel und zugehörige erhaltene Anweisungen, Gesundheitstermine und Daten im persönlichen klinischen Tagebuch." },
						{ type: "p", text: "Diese Daten sind für die Nutzung der Gesundheitsfunktionen der App erforderlich. Der Nutzer kann die Einwilligung widerrufen, die Einstellungen zur Datenspeicherung ändern oder sein Konto gemäß den in der Datenschutzerklärung und auf der Seite zur Kontolöschung angegebenen Verfahren löschen." },
						{ type: "h2", text: "Werbung" },
						{ type: "p", text: "Die App kann Werbung über Google Mobile Ads (AdMob) anzeigen. Personalisierte Anzeigen werden nur gemäß den vom Nutzer geäußerten Präferenzen und über die in der App verfügbaren Einwilligungsmechanismen angezeigt." },
						...
						{ type: "p", text: "Die App kann technische Tools wie Sentry verwenden, um Fehler, Abstürze und Leistungsprobleme zu erfassen, damit der Dienst gewartet, geschützt und verbessert werden kann." },
		...
		es: {
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						{ type: "p", text: "RememberTo es una aplicación dedicada a gestionar recordatorios, tratamientos farmacológicos, curas autónomas indicadas por profesionales sanitarios, citas sanitarias y seguimiento personal mediante un diario clínico." },
						{ type: "h2", text: "Datos recopilados" },
						{ type: "p", text: "La aplicación recopila los siguientes datos:" },
						{
							type: "ul",
							items: [
								...
								"Datos de salud: medicamentos, tratamientos, recordatorios, curas autónomas indicadas por un médico o personal sanitario, zona a curar, materiales necesarios, instrucciones recibidas, citas sanitarias, diario clínico personal, parámetros vitales, síntomas, efectos secundarios, datos glucémicos y notas de salud",
						...
						{ type: "h2", text: "Finalidades del tratamiento" },
						{
							...
							items: [
								...
								"gestión de recordatorios, tratamientos farmacológicos, niveles de aviso y alarmas locales de alta prioridad elegidos por el usuario",
								"envío de notificaciones push y visualización de avisos locales en el dispositivo",
								"seguimiento personal de salud mediante el diario clínico, diario de medicamentos y diario de curas",
						...
						{ type: "p", text: "Los medicamentos finalizados y su diario, las curas finalizadas y su diario, y las entradas del diario de salud pueden eliminarse automáticamente después de 30, 60, 90 o 120 días; el valor predeterminado es 90 días. Las citas pasadas se eliminan automáticamente 15 días después de la fecha de la cita." },
						{ type: "p", text: "El usuario puede eliminar manualmente los datos en cualquier momento desde las funciones disponibles en la aplicación, o eliminar definitivamente la cuenta y los datos desde la aplicación o contactando a rememberto.info@gmail.com." },
						{ type: "h2", text: "Aviso médico" },
						{ type: "p", text: "RememberTo no proporciona asesoramiento médico, no explica cómo realizar curas y no sustituye la opinión de un médico o profesional sanitario. Las curas deben realizarse solo si han sido indicadas por un médico o por personal sanitario cualificado." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "Para los medicamentos, el usuario puede elegir un aviso normal basado en notificaciones o un aviso de nivel alto, que programa en el dispositivo una alarma local exacta con sonido, vibración y posible apertura a pantalla completa, incluso con el dispositivo bloqueado, dentro de los límites permitidos por Android y por los ajustes del dispositivo. El nivel alto debe elegirse expresamente para cada medicamento y requiere permisos especiales para alarmas exactas y avisos a pantalla completa. El usuario o el sistema pueden denegar o revocar dichos permisos. Las notificaciones y alarmas pueden sufrir retrasos, verse limitadas o no mostrarse debido a los ajustes del dispositivo, ahorro de energía, permisos, indisponibilidad de servicios, reinicios, actualizaciones u otros factores técnicos y, por tanto, no están garantizadas." },
						{ type: "h2", text: "Contenidos de salud" },
						{ type: "p", text: "La aplicación no sustituye a médicos ni profesionales sanitarios, no prescribe tratamientos y no proporciona instrucciones autónomas sobre cómo realizar curas." },
						{ type: "h2", text: "Responsabilidad del usuario" },
						{ type: "p", text: "El usuario es responsable de la correcta gestión de sus tratamientos, de la toma de sus medicamentos y de realizar curas solo según las indicaciones recibidas de un médico o de personal sanitario cualificado. También es responsable de elegir el nivel de aviso, de la exactitud de los horarios introducidos y de comprobar periódicamente el volumen, los permisos y los ajustes del dispositivo. RememberTo no debe utilizarse como único sistema para recordatorios sanitarios urgentes, críticos o vitales." },
						...
						{ type: "p", text: "En la medida permitida por la ley, el desarrollador no es responsable de errores, interrupciones del servicio, retrasos, falta de activación o supresión de notificaciones y alarmas debidas al dispositivo, sistema operativo, permisos, conectividad o servicios de terceros, ni de la pérdida de datos o de las consecuencias derivadas de confiar exclusivamente en los recordatorios de la aplicación." },
						...
						{ type: "h2", text: "Conservación y eliminación de datos" },
						{ type: "p", text: "El usuario puede elegir si conservar medicamentos finalizados, curas finalizadas y entradas del diario de salud durante 30, 60, 90 o 120 días, con un valor predeterminado de 90 días. Las citas pasadas se eliminan automáticamente 15 días después de la fecha de la cita." },
						{ type: "p", text: "El usuario puede, en cualquier caso, eliminar manualmente los datos cuando lo desee: los medicamentos finalizados desde el diario de medicamentos en la sección dedicada, y las curas y entradas del diario de salud directamente desde sus respectivas tarjetas." },
						{ type: "h2", text: "Datos de salud y consentimiento" },
						{ type: "p", text: "El uso de las funcionalidades de salud de la aplicación requiere el consentimiento explícito del usuario para el tratamiento de los datos de salud necesarios para el funcionamiento de RememberTo, incluidos medicamentos, tratamientos, recordatorios, curas autónomas e instrucciones recibidas relacionadas, citas sanitarias y datos introducidos en el diario clínico personal." },
						{ type: "p", text: "Dichos datos son necesarios para usar las funcionalidades de salud de la aplicación. El usuario puede retirar el consentimiento, modificar los ajustes de conservación de datos o eliminar su cuenta según las modalidades indicadas en la Política de privacidad y en la página dedicada a la eliminación de cuenta." },
		...
		pt: {
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						{ type: "p", text: "RememberTo é uma app dedicada à gestão de lembretes, terapias medicamentosas, pensos autónomos indicados por profissionais de saúde, consultas de saúde e monitorização pessoal através de um diário clínico." },
						{ type: "h2", text: "Dados recolhidos" },
						{ type: "p", text: "A app recolhe os seguintes dados:" },
						{
							type: "ul",
							items: [
								"Dados da conta: nome, email, palavra-passe, data de nascimento, sexo, nacionalidade, idioma",
								"Dados opcionais: número de telefone",
								"Dados de saúde: medicamentos, terapias, lembretes, pensos autónomos indicados por médico ou profissional de saúde, zona a tratar, materiais necessários, instruções recebidas, consultas de saúde, diário clínico pessoal, parâmetros vitais, sintomas, efeitos secundários, dados glicémicos e notas de saúde",
						...
						{ type: "h2", text: "Finalidades do tratamento" },
						{
							...
							items: [
								...
								"gestão de lembretes, terapias medicamentosas, níveis de aviso e alarmes locais de alta prioridade escolhidos pela pessoa utilizadora",
								"envio de notificações push e apresentação de avisos locais no dispositivo",
								"monitorização pessoal de saúde através do diário clínico, diário de medicamentos e diário de pensos",
						...
						{ type: "p", text: "Medicamentos concluídos e respetivo diário, pensos concluídos e respetivo diário, e entradas do diário de saúde podem ser eliminados automaticamente após 30, 60, 90 ou 120 dias; o valor predefinido é 90 dias. As consultas passadas são eliminadas automaticamente 15 dias após a data da consulta." },
						{ type: "p", text: "A pessoa utilizadora pode eliminar manualmente os dados a qualquer momento através das funções disponíveis na app, ou eliminar definitivamente a conta e os dados pela app ou contactando rememberto.info@gmail.com." },
						{ type: "h2", text: "Aviso médico" },
						{ type: "p", text: "RememberTo não fornece aconselhamento médico, não explica como realizar pensos e não substitui a opinião de um médico ou profissional de saúde. Os pensos devem ser realizados apenas se indicados por um médico ou por pessoal de saúde qualificado." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "Para os medicamentos, a pessoa utilizadora pode escolher um aviso normal, baseado em notificações, ou um aviso de nível alto, que programa no dispositivo um alarme local exato com som, vibração e possível abertura em ecrã inteiro, mesmo com o dispositivo bloqueado, dentro dos limites permitidos pelo Android e pelas definições do dispositivo. O nível alto deve ser escolhido expressamente para cada medicamento e requer permissões especiais para alarmes exatos e avisos em ecrã inteiro. Essas permissões podem ser recusadas ou revogadas pela pessoa utilizadora ou pelo sistema. As notificações e os alarmes podem sofrer atrasos, ser limitados ou não ser apresentados devido às definições do dispositivo, poupança de energia, permissões, indisponibilidade dos serviços, reinícios, atualizações ou outros fatores técnicos e, por isso, não são garantidos." },
						{ type: "h2", text: "Conteúdos de saúde" },
						{ type: "p", text: "A app não substitui médicos nem profissionais de saúde, não prescreve terapias e não fornece instruções autónomas sobre como realizar pensos." },
						{ type: "h2", text: "Responsabilidade da pessoa utilizadora" },
						{ type: "p", text: "A pessoa utilizadora é responsável pela gestão correta das suas terapias, pela toma dos medicamentos e pela realização de pensos apenas segundo indicações recebidas de um médico ou de pessoal de saúde qualificado. É também responsável pela escolha do nível de aviso, pela exatidão dos horários introduzidos e pela verificação periódica do volume, das permissões e das definições do dispositivo. RememberTo não deve ser utilizada como único sistema para lembretes de saúde urgentes, críticos ou vitais." },
						{ type: "h2", text: "Cuidador" },
						...
						{ type: "p", text: "Nos limites permitidos por lei, o programador não é responsável por erros, interrupções do serviço, atrasos, falta de ativação ou supressão de notificações e alarmes devido ao dispositivo, sistema operativo, permissões, conectividade ou serviços de terceiros, nem pela perda de dados ou consequências resultantes da confiança exclusiva nos lembretes da app." },
						...
						{ type: "h2", text: "Conservação e eliminação dos dados" },
						{ type: "p", text: "A pessoa utilizadora pode escolher se conserva medicamentos concluídos, pensos concluídos e entradas do diário de saúde durante 30, 60, 90 ou 120 dias, com valor predefinido de 90 dias. As consultas passadas são eliminadas automaticamente 15 dias após a data da consulta." },
						{ type: "p", text: "A pessoa utilizadora pode, ainda assim, eliminar manualmente os dados quando desejar: medicamentos concluídos a partir do diário de medicamentos na secção dedicada, pensos e entradas do diário de saúde diretamente nos respetivos cartões." },
						{ type: "h2", text: "Dados de saúde e consentimento" },
						{ type: "p", text: "A utilização das funcionalidades de saúde da app exige consentimento explícito para o tratamento dos dados de saúde necessários ao funcionamento de RememberTo, incluindo medicamentos, terapias, lembretes, pensos autónomos e respetivas instruções recebidas, consultas de saúde e dados inseridos no diário clínico pessoal." },
						{ type: "p", text: "Esses dados são necessários para utilizar as funcionalidades de saúde da app. A pessoa utilizadora pode retirar o consentimento, alterar as definições de conservação de dados ou eliminar a própria conta segundo as modalidades indicadas na Política de privacidade e na página dedicada à eliminação da conta." },
		...
		sr: {
			...
			pages: {
				...
				privacy: {
					...
					updated: "септембар 2026.",
					blocks: [
						{ type: "p", text: "RememberTo је апликација намењена управљању подсетницима, терапијама лековима, самосталним превијањима назначеним од стране здравствених радника, здравственим терминима и личном праћењу путем клиничког дневника." },
						{ type: "h2", text: "Подаци који се прикупљају" },
						{ type: "p", text: "Апликација прикупља следеће податке:" },
						{
							type: "ul",
							items: [
								"Подаци о налогу: име, email, лозинка, датум рођења, пол, држављанство, језик",
								"Опциони подаци: број телефона",
								"Здравствени подаци: лекови, терапије, подсетници, самостална превијања назначена од стране лекара или здравственог радника, зона за превијање, потребни материјали, примљена упутства, здравствени термини, лични клинички дневник, витални параметри, симптоми, нежељени ефекти, подаци о гликемији и здравствене белешке",
						...
						{ type: "h2", text: "Сврхе обраде" },
						{
							...
							items: [
								"рад апликације",
								"управљање подсетницима, терапијама лековима, нивоима упозорења и локалним алармима високог приоритета које корисник изабере",
								"слање push обавештења и приказ локалних упозорења на уређају",
								"лично здравствено праћење путем клиничког дневника, дневника лекова и дневника превијања",
						...
						{ type: "p", text: "Главни подаци апликације обрађују се на серверима који се налазе у Европској унији." },
						{ type: "p", text: "Неке техничке услуге трећих страна, као што су push обавештења, оглашавање, дијагностика грешака или инфраструктурне услуге, могу подразумевати обраду од стране њихових добављача, укључујући и ван Европског економског простора када је то потребно, у складу са њиховим политикама приватности, условима услуге и применљивим гаранцијама." },
						...
						{ type: "p", text: "Завршени лекови и повезани дневник, завршена превијања и повезани дневник, као и уноси у здравствени дневник могу се аутоматски избрисати након 30, 60, 90 или 120 дана; подразумевана вредност је 90 дана. Прошли термини се аутоматски бришу 15 дана након датума термина." },
						{ type: "p", text: "Корисник може ручно избрисати податке у било ком тренутку преко функција доступних у апликацији или трајно избрисати налог и податке из апликације или контактирањем rememberto.info@gmail.com." },
						{ type: "h2", text: "Медицинско одрицање од одговорности" },
						{ type: "p", text: "RememberTo не пружа медицинске савете, не објашњава како се обављају превијања и не замењује мишљење лекара или здравственог радника. Превијања треба обављати само ако их је назначио лекар или квалификовани здравствени радник." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "h2", text: "Услуга" },
						{ type: "p", text: "За лекове корисник може изабрати уобичајено упозорење засновано на обавештењима или упозорење високог нивоа које на уређају заказује тачан локални аларм са звуком, вибрацијом и могућим приказом преко целог екрана, чак и када је уређај закључан, у границама које дозвољавају Android и подешавања уређаја. Високи ниво мора бити изричито изабран за сваки појединачни лек и захтева посебне дозволе за тачне аларме и упозорења преко целог екрана. Корисник или систем могу одбити или опозвати те дозволе. Обавештења и аларми могу каснити, бити ограничени или се не приказати због подешавања уређаја, уштеде енергије, дозвола, недоступности услуга, поновних покретања, ажурирања или других техничких фактора и стога нису загарантовани." },
						{ type: "h2", text: "Здравствени садржаји" },
						{ type: "p", text: "Апликација не замењује лекаре или здравствене раднике, не прописује терапије и не пружа самостална упутства о томе како се обављају превијања." },
						{ type: "h2", text: "Одговорност корисника" },
						{ type: "p", text: "Корисник је одговоран за правилно управљање својим терапијама, узимање лекова и обављање превијања само према упутствима добијеним од лекара или квалификованог здравственог радника. Такође је одговоран за избор нивоа упозорења, тачност унетих времена и периодичну проверу јачине звука, дозвола и подешавања уређаја. RememberTo се не сме користити као једини систем за хитне, критичне или животно важне здравствене подсетнике." },
						...
						{ type: "p", text: "У мери дозвољеној законом, програмер није одговоран за грешке, прекиде услуге, кашњења, неактивирање или потискивање обавештења и аларма узроковано уређајем, оперативним системом, дозволама, повезивањем или услугама трећих страна, нити за губитак података или последице настале искључивим ослањањем на подсетнике апликације." },
						...
						{ type: "h2", text: "Чување и брисање података" },
						{ type: "p", text: "Корисник може изабрати да ли ће чувати завршене лекове, завршена превијања и уносе у здравствени дневник 30, 60, 90 или 120 дана, са подразумеваном вредношћу од 90 дана. Прошли термини се аутоматски бришу 15 дана након датума термина." },
						{ type: "p", text: "Корисник ипак може ручно избрисати податке кад год жели: завршене лекове из дневника лекова у посебној секцији, а превијања и уносе у здравствени дневник директно са одговарајућих картица." },
						{ type: "h2", text: "Здравствени подаци и пристанак" },
						{ type: "p", text: "Коришћење здравствених функција апликације захтева изричит пристанак корисника на обраду здравствених података неопходних за рад RememberTo, укључујући лекове, терапије, подсетнике, самостална превијања и повезана примљена упутства, здравствене термине и податке унете у лични клинички дневник." },
						{ type: "p", text: "Ти подаци су неопходни за коришћење здравствених функција апликације. Корисник може повући пристанак, изменити подешавања чувања података или избрисати свој налог на начин наведен у Политици приватности и на страници посвећеној брисању налога." },
		...
		zh: {
			...
			pages: {
				...
				privacy: {
					...
					updated: "2026 年 9 月",
					blocks: [
						{ type: "p", text: "RememberTo 是一款用于管理提醒、药物治疗、由医疗专业人员指示的自主换药、医疗预约，并通过临床日记进行个人监测的应用。" },
						{ type: "h2", text: "收集的数据" },
						{ type: "p", text: "应用会收集以下数据：" },
						{
							type: "ul",
							items: [
								"账户数据：姓名、电子邮箱、密码、出生日期、性别、国籍、语言",
								"可选数据：电话号码",
								"健康数据：药物、治疗、提醒、由医生或医疗人员指示的自主换药、需换药部位、所需材料、收到的说明、医疗预约、个人临床日记、生命体征、症状、副作用、血糖数据和健康备注",
						...
						{ type: "h2", text: "处理目的" },
						{
							...
							items: [
								"应用运行",
								"管理提醒、药物治疗、提醒级别以及用户选择的高优先级本地闹钟",
								"发送推送通知并在设备上显示本地提醒",
								"通过临床日记、用药日记和换药日记进行个人健康监测",
								"以 PDF 导出健康数据",
								"护理者管理，以及授权用户之间的数据共享",
						...
						{ type: "h2", text: "数据传输" },
						{ type: "p", text: "应用的主要数据在位于欧盟的服务器上处理。" },
						{ type: "p", text: "某些第三方技术服务，例如推送通知、广告、错误诊断或基础设施服务，在必要时可能由各自提供商处理，包括在欧洲经济区以外处理，并遵循其隐私政策、服务条款和适用保障。" },
						{ type: "h2", text: "外部服务" },
						{
							type: "ul",
							items: [
						...
						{ type: "h2", text: "数据保留" },
						{ type: "p", text: "已结束的药物及相关日记、已结束的换药及相关日记，以及健康日记条目可在 30、60、90 或 120 天后自动删除；默认值为 90 天。已过期的预约会在预约日期后 15 天自动删除。" },
						{ type: "p", text: "用户可以随时通过应用中可用的功能手动删除数据，也可以在应用中永久删除账户和数据，或联系 rememberto.info@gmail.com。" },
						{ type: "h2", text: "医疗免责声明" },
						{ type: "p", text: "RememberTo 不提供医疗建议，不说明如何进行换药，也不能替代医生或医疗专业人员的意见。只有在医生或合格医疗人员指示的情况下才应进行换药。" },
						{ type: "h2", text: "用户权利" },
						{
							type: "ul",
							items: [
				...
				terms: {
					...
					blocks: [
						...
						{ type: "h2", text: "服务" },
						{ type: "p", text: "对于药物，用户可以选择基于通知的普通提醒，或选择高级别提醒；高级别提醒会在设备上安排带声音和振动的精确本地闹钟，并可能以全屏方式显示，即使设备已锁定也可能显示，但须受 Android 和设备设置允许的范围限制。高级别提醒必须针对每种药物明确选择，并需要精确闹钟和全屏提醒的特殊权限。用户或系统可以拒绝或撤销这些权限。由于设备设置、省电模式、权限、服务不可用、重启、更新或其他技术因素，通知和闹钟可能延迟、受到限制或不显示，因此无法保证。" },
						{ type: "h2", text: "健康内容" },
						{ type: "p", text: "本应用不能替代医生或医疗专业人员，不开具治疗方案，也不提供如何进行换药的自主说明。" },
						{ type: "h2", text: "用户责任" },
						{ type: "p", text: "用户负责正确管理自己的治疗、按要求服用药物，并仅根据医生或合格医疗人员给出的指示进行换药。用户还负责选择提醒级别、确保输入的时间正确，并定期检查设备的音量、权限和设置。RememberTo 不得作为紧急、关键或救命健康提醒的唯一系统。" },
						{ type: "h2", text: "护理者" },
						{ type: "p", text: "护理者访问数据仅在用户明确同意后进行。" },
						{ type: "p", text: "护理者只能查看用户共享的数据，不能修改这些数据。" },
						{ type: "p", text: "用户可以随时撤销对其数据的访问权限。" },
						{ type: "h2", text: "责任限制" },
						{ type: "p", text: "在法律允许的范围内，对于因设备、操作系统、权限、网络连接或第三方服务导致的错误、服务中断、延迟、通知和闹钟未激活或被抑制，开发者不承担责任；对于数据丢失或完全依赖应用提醒所造成的后果，开发者也不承担责任。" },
						{ type: "h2", text: "PDF 导出" },
						{ type: "p", text: "应用可以允许以 PDF 格式导出健康数据。" },
						{ type: "p", text: "用户负责保存并酌情共享导出的文件。" },
						{ type: "h2", text: "数据保留和删除" },
						{ type: "p", text: "用户可以选择将已结束的药物、已结束的换药和健康日记条目保留 30、60、90 或 120 天，默认值为 90 天。已过期的预约会在预约日期后 15 天自动删除。" },
						{ type: "p", text: "用户仍可在需要时手动删除数据：在专用部分从用药日记删除已结束的药物，直接从相应卡片删除换药和健康日记条目。" },
						{ type: "h2", text: "健康数据和同意" },
						{ type: "p", text: "使用应用的健康功能需要用户明确同意处理 RememberTo 运行所需的健康数据，包括药物、治疗、提醒、自主换药及收到的相关说明、医疗预约以及输入个人临床日记的数据。" },
						{ type: "p", text: "这些数据是使用应用健康功能所必需的。用户可以按照隐私政策和账户删除页面中说明的方式撤回同意、修改数据保留设置或删除自己的账户。" },
						{ type: "h2", text: "广告" },
		...
		ja: {
			...
			pages: {
				...
				privacy: {
					...
					updated: "2026年9月",
					blocks: [
						{ type: "p", text: "RememberTo は、リマインダー、服薬治療、医療専門家が指示した自己管理の創傷処置、医療予約、臨床日記による個人モニタリングを管理するためのアプリです。" },
						{ type: "h2", text: "収集するデータ" },
						{ type: "p", text: "アプリは以下のデータを収集します。" },
						{
							type: "ul",
							items: [
								"アカウントデータ: 氏名、メールアドレス、パスワード、生年月日、性別、国籍、言語",
								"任意データ: 電話番号",
								"健康データ: 薬、治療、リマインダー、医師または医療従事者が指示した自己管理の創傷処置、処置する部位、必要な材料、受け取った指示、医療予約、個人の臨床日記、バイタル値、症状、副作用、血糖データ、健康メモ",
						...
						{ type: "h2", text: "処理の目的" },
						{
							...
							items: [
								"アプリの動作",
								"リマインダー、服薬治療、通知レベル、および利用者が選択した高優先度のローカルアラームの管理",
								"プッシュ通知の送信および端末上でのローカル通知の表示",
								"臨床日記、服薬日記、創傷処置日記による個人の健康モニタリング",
								"健康データの PDF エクスポート",
						...
						{ type: "h2", text: "データ移転" },
						{ type: "p", text: "アプリの主要データは欧州連合内のサーバーで処理されます。" },
						{ type: "p", text: "プッシュ通知、広告、エラー診断、インフラサービスなど一部の第三者技術サービスは、必要に応じて欧州経済領域外を含む各提供者による処理を伴う場合があり、それぞれのプライバシーポリシー、利用規約、適用される保護措置に従います。" },
						{ type: "h2", text: "外部サービス" },
						{
							type: "ul",
							items: [
						...
						{ type: "h2", text: "データ保持" },
						{ type: "p", text: "終了した薬と関連する日記、終了した創傷処置と関連する日記、および健康日記の項目は、30、60、90、120 日後に自動削除できます。既定値は 90 日です。過去の予約は予約日の 15 日後に自動削除されます。" },
						{ type: "p", text: "利用者は、アプリ内で利用可能な機能からいつでも手動でデータを削除できます。また、アプリ内でアカウントとデータを完全に削除するか、rememberto.info@gmail.com に連絡できます。" },
						{ type: "h2", text: "医療免責事項" },
						{ type: "p", text: "RememberTo は医療助言を提供せず、創傷処置の実施方法を説明せず、医師または医療専門家の意見に代わるものではありません。創傷処置は、医師または資格のある医療従事者から指示された場合にのみ実施してください。" },
						{ type: "h2", text: "利用者の権利" },
						{
							type: "ul",
							items: [
				...
				terms: {
					...
					blocks: [
						...
						{ type: "h2", text: "サービス" },
						{ type: "p", text: "薬について、利用者は通知に基づく通常の通知、または高レベル通知を選択できます。高レベル通知では、Android および端末設定で許可される範囲内で、端末がロックされている場合でも、音、振動、全画面表示の可能性を伴う正確なローカルアラームが端末に設定されます。高レベル通知は薬ごとに明示的に選択する必要があり、正確なアラームと全画面通知のための特別な権限が必要です。これらの権限は、利用者またはシステムによって拒否または取り消される場合があります。通知およびアラームは、端末設定、省電力機能、権限、サービスの利用不能、再起動、更新、その他の技術的要因により、遅延、制限、または表示されない場合があり、保証されません。" },
						{ type: "h2", text: "健康コンテンツ" },
						{ type: "p", text: "本アプリは医師または医療専門家に代わるものではなく、治療を処方せず、創傷処置の実施方法について独自の指示を提供しません。" },
						{ type: "h2", text: "利用者の責任" },
						{ type: "p", text: "利用者は、自身の治療管理、薬の服用、および医師または資格のある医療従事者から受けた指示に従った場合に限る創傷処置の実施について責任を負います。また、通知レベルの選択、入力した時刻の正確性、端末の音量、権限、設定の定期的な確認についても責任を負います。RememberTo を、緊急、重大、または救命に関わる健康リマインダーの唯一の手段として使用してはなりません。" },
						{ type: "h2", text: "介護者" },
						...
						{ type: "h2", text: "責任の制限" },
						{ type: "p", text: "法律で認められる範囲において、開発者は、端末、オペレーティングシステム、権限、接続、または第三者サービスに起因するエラー、サービス中断、遅延、通知やアラームの不作動または抑制について責任を負わず、データ損失またはアプリのリマインダーのみに依存したことから生じる結果についても責任を負いません。" },
						...
						{ type: "h2", text: "データの保持と削除" },
						{ type: "p", text: "利用者は、終了した薬、終了した創傷処置、健康日記の項目を 30、60、90、120 日のいずれかで保持するかを選択できます。既定値は 90 日です。過去の予約は予約日の 15 日後に自動削除されます。" },
						{ type: "p", text: "利用者は、希望する場合いつでも手動でデータを削除できます。終了した薬は専用セクションの服薬日記から、創傷処置と健康日記の項目はそれぞれのカードから直接削除できます。" },
						{ type: "h2", text: "健康データと同意" },
						{ type: "p", text: "アプリの健康機能を使用するには、薬、治療、リマインダー、自己管理の創傷処置と受け取った関連指示、医療予約、個人の臨床日記に入力されたデータを含む、RememberTo の動作に必要な健康データの処理について、利用者の明示的な同意が必要です。" },
						{ type: "p", text: "これらのデータは、アプリの健康機能を使用するために必要です。利用者は、プライバシーポリシーおよびアカウント削除ページに記載された方法に従って、同意を撤回したり、データ保持設定を変更したり、アカウントを削除したりできます。" },
						{ type: "h2", text: "広告" },
		...
		ar: {
			...
			pages: {
				...
				privacy: {
					...
					updated: "سبتمبر 2026",
					blocks: [
						{ type: "p", text: "RememberTo هو تطبيق مخصص لإدارة التذكيرات والعلاجات الدوائية والتضميدات الذاتية التي يحددها متخصصو الرعاية الصحية والمواعيد الصحية والمتابعة الشخصية من خلال يوميات سريرية." },
						{ type: "h2", text: "البيانات التي يتم جمعها" },
						{ type: "p", text: "يجمع التطبيق البيانات التالية:" },
						{
							type: "ul",
							items: [
								"بيانات الحساب: الاسم، البريد الإلكتروني، كلمة المرور، تاريخ الميلاد، الجنس، الجنسية، اللغة",
								"بيانات اختيارية: رقم الهاتف",
								"بيانات صحية: الأدوية، العلاجات، التذكيرات، التضميدات الذاتية التي يحددها طبيب أو موظفو رعاية صحية، المنطقة المراد تضميدها، المواد اللازمة، التعليمات المستلمة، المواعيد الصحية، اليوميات السريرية الشخصية، المؤشرات الحيوية، الأعراض، الآثار الجانبية، بيانات السكر في الدم والملاحظات الصحية",
						...
						{ type: "h2", text: "أغراض المعالجة" },
						{
							...
							items: [
								"تشغيل التطبيق",
								"إدارة التذكيرات والعلاجات الدوائية ومستويات التنبيه والمنبهات المحلية عالية الأولوية التي يختارها المستخدم",
								"إرسال الإشعارات الفورية وعرض التنبيهات المحلية على الجهاز",
								"المتابعة الصحية الشخصية من خلال اليوميات السريرية ويوميات الأدوية ويوميات التضميدات",
						...
						{ type: "p", text: "تعالج البيانات الرئيسية للتطبيق على خوادم تقع داخل الاتحاد الأوروبي." },
						{ type: "p", text: "قد تنطوي بعض الخدمات التقنية التابعة لأطراف ثالثة، مثل الإشعارات الفورية أو الإعلانات أو تشخيص الأخطاء أو خدمات البنية التحتية، على معالجة من قبل مزوديها، بما في ذلك خارج المنطقة الاقتصادية الأوروبية عند الضرورة، وفقا لسياسات الخصوصية وشروط الخدمة والضمانات المعمول بها لديهم." },
						...
						{ type: "p", text: "يمكن حذف الأدوية المنتهية واليوميات المرتبطة بها، والتضميدات المنتهية واليوميات المرتبطة بها، وإدخالات يوميات الصحة تلقائيا بعد 30 أو 60 أو 90 أو 120 يوما؛ والقيمة الافتراضية هي 90 يوما. يتم حذف المواعيد الماضية تلقائيا بعد 15 يوما من تاريخ الموعد." },
						{ type: "p", text: "يمكن للمستخدم حذف البيانات يدويا في أي وقت من خلال الوظائف المتاحة في التطبيق، أو حذف الحساب والبيانات نهائيا من التطبيق أو عن طريق التواصل مع rememberto.info@gmail.com." },
						{ type: "h2", text: "إخلاء مسؤولية طبية" },
						{ type: "p", text: "لا يقدم RememberTo نصائح طبية، ولا يشرح كيفية تنفيذ التضميدات، ولا يحل محل رأي طبيب أو أخصائي رعاية صحية. يجب تنفيذ التضميدات فقط إذا حددها طبيب أو موظفو رعاية صحية مؤهلون." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "h2", text: "الخدمة" },
						{ type: "p", text: "بالنسبة إلى الأدوية، يمكن للمستخدم اختيار تنبيه عادي قائم على الإشعارات أو تنبيه عالي المستوى يقوم بجدولة منبه محلي دقيق على الجهاز مع صوت واهتزاز وإمكانية العرض بملء الشاشة، حتى عندما يكون الجهاز مقفلا، ضمن الحدود التي يسمح بها Android وإعدادات الجهاز. يجب اختيار المستوى العالي صراحة لكل دواء، ويتطلب أذونات خاصة للمنبهات الدقيقة والتنبيهات بملء الشاشة. يمكن للمستخدم أو النظام رفض هذه الأذونات أو إلغاؤها. قد تتأخر الإشعارات والمنبهات أو تكون محدودة أو لا تظهر بسبب إعدادات الجهاز أو توفير الطاقة أو الأذونات أو عدم توفر الخدمات أو إعادة التشغيل أو التحديثات أو عوامل تقنية أخرى، ولذلك فهي غير مضمونة." },
						{ type: "h2", text: "المحتوى الصحي" },
						{ type: "p", text: "لا يحل التطبيق محل الأطباء أو أخصائيي الرعاية الصحية، ولا يصف علاجات، ولا يقدم تعليمات مستقلة حول كيفية تنفيذ التضميدات." },
						{ type: "h2", text: "مسؤولية المستخدم" },
						{ type: "p", text: "يتحمل المستخدم مسؤولية الإدارة الصحيحة لعلاجاته وتناول أدويته وتنفيذ التضميدات فقط وفقا للتعليمات المستلمة من طبيب أو موظفي رعاية صحية مؤهلين. كما يتحمل مسؤولية اختيار مستوى التنبيه وصحة الأوقات المدخلة والتحقق دوريا من مستوى الصوت والأذونات وإعدادات الجهاز. يجب عدم استخدام RememberTo كنظام وحيد للتذكيرات الصحية العاجلة أو الحرجة أو المنقذة للحياة." },
						...
						{ type: "p", text: "في الحدود التي يسمح بها القانون، لا يكون المطور مسؤولا عن الأخطاء أو انقطاع الخدمة أو التأخير أو عدم تفعيل الإشعارات والمنبهات أو حجبها بسبب الجهاز أو نظام التشغيل أو الأذونات أو الاتصال أو خدمات الأطراف الثالثة، ولا عن فقدان البيانات أو العواقب الناتجة عن الاعتماد الحصري على تذكيرات التطبيق." },
						...
						{ type: "h2", text: "الاحتفاظ بالبيانات وحذفها" },
						{ type: "p", text: "يمكن للمستخدم اختيار الاحتفاظ بالأدوية المنتهية والتضميدات المنتهية وإدخالات يوميات الصحة لمدة 30 أو 60 أو 90 أو 120 يوما، مع قيمة افتراضية قدرها 90 يوما. يتم حذف المواعيد الماضية تلقائيا بعد 15 يوما من تاريخ الموعد." },
						{ type: "p", text: "ومع ذلك يمكن للمستخدم حذف البيانات يدويا متى أراد: الأدوية المنتهية من يوميات الأدوية في القسم المخصص، والتضميدات وإدخالات يوميات الصحة مباشرة من البطاقات الخاصة بها." },
						{ type: "h2", text: "البيانات الصحية والموافقة" },
						{ type: "p", text: "يتطلب استخدام الوظائف الصحية في التطبيق موافقة صريحة من المستخدم على معالجة البيانات الصحية اللازمة لتشغيل RememberTo، بما في ذلك الأدوية والعلاجات والتذكيرات والتضميدات الذاتية والتعليمات المرتبطة المستلمة والمواعيد الصحية والبيانات المدخلة في اليوميات السريرية الشخصية." },
						{ type: "p", text: "هذه البيانات ضرورية لاستخدام الوظائف الصحية في التطبيق. يمكن للمستخدم سحب الموافقة أو تعديل إعدادات الاحتفاظ بالبيانات أو حذف حسابه وفقا للطرق الموضحة في سياسة الخصوصية وصفحة حذف الحساب." },
