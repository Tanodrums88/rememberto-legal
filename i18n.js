			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						{
							type: "p",
							text: "RememberTo è un'app dedicata alla gestione di promemoria, terapie farmacologiche, medicazioni autonome indicate da professionisti sanitari, appuntamenti sanitari e monitoraggio personale tramite diario clinico.",
						},
						...
						{
							type: "p",
							text: "I dati sanitari sono conservati secondo le impostazioni scelte dall'utente nell'app. Farmaci conclusi e relativo diario, medicazioni concluse e relativo diario, e voci del diario salute possono essere eliminati automaticamente dopo 30, 60, 90 o 120 giorni; il valore predefinito è 90 giorni. Gli appuntamenti non sono soggetti a questa conservazione automatica.",
						},
						{
							type: "p",
							text: "L'utente può cancellare manualmente i dati in qualsiasi momento dalle funzioni disponibili nell'app oppure eliminare definitivamente account e dati dall'app o contattando rememberto.info@gmail.com.",
						},
						{ type: "h2", text: "Disclaimer medico" },
						{
							type: "p",
							text: "RememberTo non fornisce consulenza medica, non spiega come eseguire medicazioni e non sostituisce il parere di un medico o professionista sanitario. Le medicazioni devono essere eseguite solo se indicate da un medico o da personale sanitario qualificato.",
						},
				...
				terms: {
					...
					blocks: [
						...
						{
							type: "p",
							text: "L'utente è responsabile della corretta gestione delle proprie terapie, dell'assunzione dei farmaci e dell'esecuzione di medicazioni solo secondo indicazioni ricevute da un medico o da personale sanitario qualificato.",
						},
						...
						{
							type: "p",
							text: "L'utilizzo delle funzionalità sanitarie dell'app richiede il consenso esplicito dell'utente al trattamento dei dati sanitari necessari al funzionamento di RememberTo, inclusi farmaci, terapie, promemoria, medicazioni autonome e relative istruzioni ricevute, appuntamenti sanitari e dati inseriti nel diario clinico personale.",
						},
						{
							type: "p",
							text: "Tali dati sono necessari per l'utilizzo delle funzionalità sanitarie dell'app. L'utente può revocare il consenso, modificare le impostazioni di conservazione dati o eliminare il proprio account secondo le modalità indicate nella Privacy Policy e nella pagina dedicata all'eliminazione account.",
						},
						{ type: "h2", text: "Conservazione e cancellazione dei dati" },
						{
							type: "p",
							text: "L'utente può scegliere se conservare farmaci conclusi, medicazioni concluse e voci del diario salute per 30, 60, 90 o 120 giorni, con valore predefinito di 90 giorni. La cancellazione automatica opera secondo tali impostazioni e non riguarda gli appuntamenti.",
						},
						{
							type: "p",
							text: "L'utente può comunque eliminare manualmente i dati quando desidera: i farmaci conclusi dal diario farmaci nella sezione dedicata, medicazioni e voci del diario salute direttamente dalle rispettive card.",
						},
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						{
							type: "p",
							text: "RememberTo is an app dedicated to managing reminders, medication therapies, self-administered dressings indicated by healthcare professionals, healthcare appointments and personal monitoring through a clinical journal.",
						},
						...
						{
							type: "p",
							text: "The user can manually delete data at any time through the features available in the app, or permanently delete the account and data from the app or by contacting rememberto.info@gmail.com.",
						},
				...
				terms: {
					...
					blocks: [
						...
						{
							type: "p",
							text: "Use of the app's health features requires the user's explicit consent to process the health data needed for RememberTo to operate, including medicines, therapies, reminders, self-administered dressings and related instructions received, healthcare appointments and data entered in the personal clinical journal.",
						},
						{
							type: "p",
							text: "Such data is necessary to use the app's health features. The user can withdraw consent, change data retention settings or delete their account according to the methods described in the Privacy Policy and on the account deletion page.",
						},
						{ type: "h2", text: "Data retention and deletion" },
						{
							type: "p",
							text: "The user can choose whether to retain completed medicines, completed dressings and health journal entries for 30, 60, 90 or 120 days, with a default value of 90 days. Automatic deletion operates according to these settings and does not apply to appointments.",
						},
						{
							type: "p",
							text: "The user can still manually delete data whenever they wish: completed medicines from the medication journal in the dedicated section, and dressings and health journal entries directly from their respective cards.",
						},
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						{
							type: "p",
							text: "RememberTo est une application dédiée à la gestion des rappels, des traitements médicamenteux, des pansements autonomes indiqués par des professionnels de santé, des rendez-vous de santé et du suivi personnel au moyen d'un journal clinique.",
						},
				...
				terms: {
					...
					blocks: [
						...
						{
							type: "p",
							text: "Ces données sont nécessaires à l'utilisation des fonctionnalités de santé de l'application. L'utilisateur peut retirer son consentement, modifier les paramètres de conservation des données ou supprimer son compte selon les modalités indiquées dans la Politique de confidentialité et sur la page dédiée à la suppression du compte.",
						},
						{ type: "h2", text: "Conservation et suppression des données" },
						{
							type: "p",
							text: "L'utilisateur peut choisir de conserver les médicaments terminés, les pansements terminés et les entrées du journal de santé pendant 30, 60, 90 ou 120 jours, avec une valeur par défaut de 90 jours. La suppression automatique fonctionne selon ces paramètres et ne concerne pas les rendez-vous.",
						},
						{
							type: "p",
							text: "L'utilisateur peut toutefois supprimer manuellement les données quand il le souhaite : les médicaments terminés depuis le journal des médicaments dans la section dédiée, les pansements et les entrées du journal de santé directement depuis leurs cartes respectives.",
						},
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						{
							type: "p",
							text: "RememberTo ist eine App zur Verwaltung von Erinnerungen, medikamentösen Therapien, selbst durchgeführten Verbandswechseln nach Anweisung von medizinischem Fachpersonal, Gesundheitsterminen und persönlicher Überwachung über ein klinisches Tagebuch.",
						},
				...
				terms: {
					...
					blocks: [
						...
						{
							type: "p",
							text: "Diese Daten sind für die Nutzung der Gesundheitsfunktionen der App erforderlich. Der Nutzer kann die Einwilligung widerrufen, die Einstellungen zur Datenspeicherung ändern oder sein Konto gemäß den in der Datenschutzerklärung und auf der Seite zur Kontolöschung angegebenen Verfahren löschen.",
						},
						{ type: "h2", text: "Datenspeicherung und Löschung" },
						{
							type: "p",
							text: "Der Nutzer kann wählen, ob abgeschlossene Medikamente, abgeschlossene Verbandswechsel und Einträge im Gesundheitstagebuch 30, 60, 90 oder 120 Tage lang aufbewahrt werden, mit einem Standardwert von 90 Tagen. Die automatische Löschung erfolgt gemäß diesen Einstellungen und betrifft keine Termine.",
						},
						{
							type: "p",
							text: "Der Nutzer kann Daten dennoch jederzeit manuell löschen: abgeschlossene Medikamente aus dem Medikamententagebuch im entsprechenden Bereich, Verbandswechsel und Einträge im Gesundheitstagebuch direkt über die jeweiligen Karten.",
						},
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						{
							type: "p",
							text: "RememberTo es una aplicación dedicada a gestionar recordatorios, tratamientos farmacológicos, curas autónomas indicadas por profesionales sanitarios, citas sanitarias y seguimiento personal mediante un diario clínico.",
						},
				...
				terms: {
					...
					blocks: [
						...
						{
							type: "p",
							text: "El usuario puede elegir si conservar medicamentos finalizados, curas finalizadas y entradas del diario de salud durante 30, 60, 90 o 120 días, con un valor predeterminado de 90 días. La eliminación automática opera según dichos ajustes y no afecta a las citas.",
						},
						{
							type: "p",
							text: "El usuario puede, en cualquier caso, eliminar manualmente los datos cuando lo desee: los medicamentos finalizados desde el diario de medicamentos en la sección dedicada, y las curas y entradas del diario de salud directamente desde sus respectivas tarjetas.",
						},
			...
			pages: {
				...
				terms: {
					...
					blocks: [
						...
						{
							type: "p",
							text: "A pessoa utilizadora pode escolher se conserva medicamentos concluídos, pensos concluídos e entradas do diário de saúde durante 30, 60, 90 ou 120 dias, com valor predefinido de 90 dias. A eliminação automática funciona segundo essas definições e não se aplica às consultas.",
						},
						{
							type: "p",
							text: "A pessoa utilizadora pode, ainda assim, eliminar manualmente os dados quando desejar: medicamentos concluídos a partir do diário de medicamentos na secção dedicada, pensos e entradas do diário de saúde diretamente nos respetivos cartões.",
						},
			...
			pages: {
				...
				terms: {
					...
					blocks: [
						...
						{
							type: "p",
							text: "Корисник може изабрати да ли ће чувати завршене лекове, завршена превијања и уносе у здравствени дневник 30, 60, 90 или 120 дана, са подразумеваном вредношћу од 90 дана. Аутоматско брисање се врши према тим подешавањима и не односи се на термине.",
						},
						{
							type: "p",
							text: "Корисник ипак може ручно избрисати податке кад год жели: завршене лекове из дневника лекова у посебној секцији, а превијања и уносе у здравствени дневник директно са одговарајућих картица.",
						},
			...
			pages: {
				...
				terms: {
					...
					blocks: [
						...
						{
							type: "p",
							text: "用户可以选择将已结束的药物、已结束的换药和健康日记条目保留 30、60、90 或 120 天，默认值为 90 天。自动删除会按照这些设置执行，不适用于预约。",
						},
						{
							type: "p",
							text: "用户仍可在需要时手动删除数据：在专用部分从用药日记删除已结束的药物，直接从相应卡片删除换药和健康日记条目。",
						},
						{ type: "h2", text: "广告" },
			...
			pages: {
				...
				terms: {
					...
					blocks: [
						...
						{
							type: "p",
							text: "利用者は、終了した薬、終了した創傷処置、健康日記の項目を 30、60、90、120 日のいずれかで保持するかを選択できます。既定値は 90 日です。自動削除はこれらの設定に従って行われ、予約には適用されません。",
						},
						{
							type: "p",
							text: "利用者は、希望する場合いつでも手動でデータを削除できます。終了した薬は専用セクションの服薬日記から、創傷処置と健康日記の項目はそれぞれのカードから直接削除できます。",
						},
						{ type: "h2", text: "広告" },
			...
			pages: {
				...
				terms: {
					...
					blocks: [
						...
						{
							type: "p",
							text: "يمكن للمستخدم اختيار الاحتفاظ بالأدوية المنتهية والتضميدات المنتهية وإدخالات يوميات الصحة لمدة 30 أو 60 أو 90 أو 120 يوما، مع قيمة افتراضية قدرها 90 يوما. يعمل الحذف التلقائي وفقا لهذه الإعدادات ولا ينطبق على المواعيد.",
						},
						{
							type: "p",
							text: "ومع ذلك يمكن للمستخدم حذف البيانات يدويا متى أراد: الأدوية المنتهية من يوميات الأدوية في القسم المخصص، والتضميدات وإدخالات يوميات الصحة مباشرة من البطاقات الخاصة بها.",
						},
