			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						...
						{ type: "p", text: "I dati sanitari sono conservati secondo le impostazioni scelte dall'utente nell'app. Farmaci conclusi e relativo diario, medicazioni concluse e relativo diario, e voci del diario salute possono essere eliminati automaticamente dopo 30, 60, 90 o 120 giorni; il valore predefinito è 90 giorni. Gli appuntamenti non sono soggetti a questa conservazione automatica." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "L'utente può scegliere se conservare farmaci conclusi, medicazioni concluse e voci del diario salute per 30, 60, 90 o 120 giorni, con valore predefinito di 90 giorni. La cancellazione automatica opera secondo tali impostazioni e non riguarda gli appuntamenti." },
			...
			pages: {
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "The user can choose whether to retain completed medicines, completed dressings and health journal entries for 30, 60, 90 or 120 days, with a default value of 90 days. Automatic deletion operates according to these settings and does not apply to appointments." },
			...
			pages: {
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "L'utilisateur peut choisir de conserver les médicaments terminés, les pansements terminés et les entrées du journal de santé pendant 30, 60, 90 ou 120 jours, avec une valeur par défaut de 90 jours. La suppression automatique fonctionne selon ces paramètres et ne concerne pas les rendez-vous." },
			...
			pages: {
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "El usuario puede elegir si conservar medicamentos finalizados, curas finalizadas y entradas del diario de salud durante 30, 60, 90 o 120 días, con un valor predeterminado de 90 días. La eliminación automática opera según dichos ajustes y no afecta a las citas." },
			...
			pages: {
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "A pessoa utilizadora pode escolher se conserva medicamentos concluídos, pensos concluídos e entradas do diário de saúde durante 30, 60, 90 ou 120 dias, com valor predefinido de 90 dias. A eliminação automática funciona segundo essas definições e não se aplica às consultas." },
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						...
						{ type: "p", text: "Здравствени подаци се чувају у складу са подешавањима која корисник изабере у апликацији. Завршени лекови и повезани дневник, завршена превијања и повезани дневник, као и уноси у здравствени дневник могу се аутоматски избрисати након 30, 60, 90 или 120 дана; подразумевана вредност је 90 дана. Термини нису обухваћени овом аутоматском политиком чувања." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "Корисник може изабрати да ли ће чувати завршене лекове, завршена превијања и уносе у здравствени дневник 30, 60, 90 или 120 дана, са подразумеваном вредношћу од 90 дана. Аутоматско брисање се врши према тим подешавањима и не односи се на термине." },
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						...
						{ type: "h2", text: "数据保留" },
						{ type: "p", text: "健康数据会根据用户在应用中选择的设置保留。已结束的药物及相关日记、已结束的换药及相关日记，以及健康日记条目可在 30、60、90 或 120 天后自动删除；默认值为 90 天。预约不受此自动保留设置影响。" },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "用户可以选择将已结束的药物、已结束的换药和健康日记条目保留 30、60、90 或 120 天，默认值为 90 天。自动删除会按照这些设置执行，不适用于预约。" },
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						...
						{ type: "h2", text: "データ保持" },
						{ type: "p", text: "健康データは、利用者がアプリ内で選択した設定に従って保持されます。終了した薬と関連する日記、終了した創傷処置と関連する日記、および健康日記の項目は、30、60、90、120 日後に自動削除できます。既定値は 90 日です。予約はこの自動保持の対象ではありません。" },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "利用者は、終了した薬、終了した創傷処置、健康日記の項目を 30、60、90、120 日のいずれかで保持するかを選択できます。既定値は 90 日です。自動削除はこれらの設定に従って行われ、予約には適用されません。" },
			...
			pages: {
				...
				privacy: {
					...
					blocks: [
						...
						{ type: "p", text: "يتم الاحتفاظ بالبيانات الصحية وفقا للإعدادات التي يختارها المستخدم في التطبيق. يمكن حذف الأدوية المنتهية واليوميات المرتبطة بها، والتضميدات المنتهية واليوميات المرتبطة بها، وإدخالات يوميات الصحة تلقائيا بعد 30 أو 60 أو 90 أو 120 يوما؛ والقيمة الافتراضية هي 90 يوما. لا تخضع المواعيد لهذا الاحتفاظ التلقائي." },
				...
				terms: {
					...
					blocks: [
						...
						{ type: "p", text: "يمكن للمستخدم اختيار الاحتفاظ بالأدوية المنتهية والتضميدات المنتهية وإدخالات يوميات الصحة لمدة 30 أو 60 أو 90 أو 120 يوما، مع قيمة افتراضية قدرها 90 يوما. يعمل الحذف التلقائي وفقا لهذه الإعدادات ولا ينطبق على المواعيد." },
